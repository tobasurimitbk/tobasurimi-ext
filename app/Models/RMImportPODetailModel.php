...
class RMImportPODetailModel extends Model
{
    ...
    protected $allowedFields    = ['id', 'rm_import_po_id', 'purchase_request_detail_id', 'barang_id', 'item_desc', 'spec', 'note', 'unit', 'qty', 'price',
    ...
    public function getPurchaseOrderDetailByPurchaseOrderId($id)
    {
        ...
        rm_import_pos.status_penerimaan, barangs.nama_barang, barangs.kode_barang, satuans.id as id_satuan, satuans.nama_satuan, hs_codes.code as hs_code")
    ...
    public function getPurchaseOrderDetailByPurchaseRequestDetailId($id)
    {
        $arrCondition = [
            'rm_import_po_details.deletedAt' => null,
            'rm_import_po_details.purchase_request_detail_id' => $id
        ];
