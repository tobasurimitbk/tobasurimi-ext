...
class StockRevampLogModel extends Model
{
    ...
    public function getKartuStockKeluar(
        ...
        (
            ...
            LEFT JOIN divisis ON material_request_details.divisi_id = divisis.id
            LEFT JOIN warehouses ON material_request_details.warehouse_id = warehouses.id
            WHERE stock_revamp_log.deletedAt IS NULL
        ...
        (
            ...
            SELECT
                stock_revamp_detail.stock_id,
                stock_revamp_log.id,
                stock_revamp_log.reference_tujuan_type AS reference_tujuan_type,
                divisis.divisi AS divisi_tujuan,
                warehouses.warehouse_name AS warehouse_tujuan,
                material_requests_penolong.req_no AS reference_no,
            ...
            LEFT JOIN divisis ON material_request_penolong_details.divisi_id = divisis.id
            LEFT JOIN warehouses ON material_request_penolong_details.warehouse_id = warehouses.id
            WHERE stock_revamp_log.deletedAt IS NULL
