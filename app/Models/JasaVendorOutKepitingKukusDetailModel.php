...
class JasaVendorOutKepitingKukusDetailModel extends Model
{
    protected $DBGroup          = 'default';
    protected $table            = 'jasa_vendor_out_kepiting_kukus_detail';
        ...
        foreach ($jasaVendorOutData as $j) {
            ...
            if ($stockListOutDetail) {
                ...
                $jasaVendorIn = $jasaVendorInModel
                    ...
                    ->where('jasa_vendor_in_kepiting_kukus.company_id',  session()->get("login")->this_company_id)
                    ->first();
    ...
    public function getJasaVendorOutDetail($jasaVendorOutKepitingKukusId)
    {
        $result = [];

        $details = $this->asArray()
            ->select('
