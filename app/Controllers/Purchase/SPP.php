        ...
        if ($response["code"] === 200) {
            ...
            foreach ($body as $data) {
                array_push($dataSPP, [
                    ...
                    "isApproveWarehouse" => ($this->role_id === 22 && $data->is_posted === false) ? ($data->approvedByHeadwarehouseName === "false" ? true : false) : false,
                    "isApprovePurchasing" => ($this->role_id === 23 && $data->is_posted === false) ? ($data->approvedByHeadofPurchasingName === "false" ? true : false) : false,
                    "isApproveDirector" => ($this->role_id === 21 && $data->is_posted === false) ? ($data->approvedByDirectorName === "false" ? true : false) : false
                ]);
            }
        }
