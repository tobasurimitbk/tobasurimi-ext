...
class ReturnBarangImportPOBP extends BaseController
{
    ...
    public function posting()
    {
        ...
        try {
            ...
            $pengembalianBarangList = $this->pengembalianBarangDetailModel->where('pengembalian_barang_id', $id)->where('deletedAt', null)->findAll();
