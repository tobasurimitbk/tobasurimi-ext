...
class SupplierBahanBakuImport extends BaseController
{
    protected $token;
    ...
    public function supplierBahanBakuImport()
    {
        ...
        return view('Supplier/supplierBahanBakuImport/index', $data);
    }

    public function allSupplierBahanBakuImport()
    {
        $payload = [
    ...
    public function getByIdSupplierBahanBakuImport($id)
    {
        $supplierModel = new SupplierModel();
    ...
    {
        $supplierModel = new SupplierModel();
        $dataSupplier = $supplierModel->getSupplierByKategoriAndType('IMPORT', 'BAHAN BAKU', $this->this_company_id);
