...
class HistoriPengirimanPesanan extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('Laporan/LaporanSales/LaporanHistoriPengirimanPesanan/index', $data);
    }
    ...
    public function allTransaksi()
    {
        ...
        $dataSalesOrder = $this->suratJalanModel
    ...
    public function printPDFAll($tglAwal = "all", $tglAkhir = "now", $filter = "all", $search = "all")
    {
        ...
        $dompdf = new Dompdf();
        $dompdf->loadHtml(view('Laporan/LaporanSales/LaporanHistoriPengirimanPesanan/print', $data));
    ...
    public function printExcelAll($tglAwal = "all", $tglAkhir = "now", $filter = "all", $search = "all")
    {
        ...
        $sheet->setCellValue('A2', 'Histori Pengiriman Pesanan');
        ...
        $sheet->fromArray([
            ...
            "Nama Barang", "Tgl DO", "Kuantitas", "Satuan", "Keterangan"]
        ], null, 'A5');
