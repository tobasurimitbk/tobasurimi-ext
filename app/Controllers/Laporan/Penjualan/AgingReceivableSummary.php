...
class AgingReceivableSummary extends BaseController
{
    ...
    public function allTransaksi()
    {
        ...
        $dataSalesOrderInvoice = $this->customerModel
            ->getListAgingReceivableSummary($condition, $addCondition, $pageSize, $offset);
    ...
    public function LaporanPenjualanPrint($tglAwal, $tglAkhir, $filter, $search)
    {
        ...
        $dompdf->loadHtml(view('Laporan/LaporanSales/LaporanAgingReceivableSummary/print', $data));
