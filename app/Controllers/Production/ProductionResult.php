        ...
        try {
            ...
            foreach ($barangDigunakan as $bd) {
                ...
                $datasbd = [
                    ...
                    "harga_umum" => (float) $bd->harga_umum || 0,
                    "harga_harian" => (float) $bd->harga_harian || 0,
                    "harga_bulanan" => (float) $bd->harga_bulanan || 0,
                ];
            ...
            foreach ($barangScrap as $bs) {
                $datasbs = [
                    ...
                    "no_ref" => "NON PABEAN",
                    "qty" => (float) $bs->qty,
                    "harga_umum" => (float) $bs->harga_umum || 0,
                    "harga_harian" => (float) $bs->harga_harian || 0,
                    "harga_bulanan" => (float) $bs->harga_bulanan || 0,
                ];
            ...
            foreach ($barangFilling as $bf) {
                $datasbf = [
                    ...
                    "harga_umum" => (float) $bf->harga_umum || 0,
                    "harga_harian" => (float) $bf->harga_harian || 0,
                    "harga_bulanan" => (float) $bf->harga_bulanan || 0,
                ];
