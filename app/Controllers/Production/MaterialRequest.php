...
class MaterialRequest extends BaseController
{
    ...
    public function getByIdMaterialRequest($id = null)
    {
        //Get Order Type By Metadata
        $MetadataModel = new MetadataModel();
        $dataOrderType =  $MetadataModel->get_by_name("Tipe PO");
    ...
    public function allMaterialRequest()
    {
        $payload = [
    ...
    public function updateMaterialRequest()
    {
        try {
            $SppModel = new SppModel();
            $SppDetailModel = new SppDetailModel();
    ...
    public function updateStatusMaterialRequest()
    {
        try {
            $id = $this->request->getPost("id");
            $SppModel = new SppModel();
    ...
    public function deleteMaterialRequest()
    {
        try {
            $SppModel = new SppModel();
            $SppDetailModel = new SppDetailModel();
