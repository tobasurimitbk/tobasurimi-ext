...
class ReturPembelianImportBB extends BaseController
{
    ...
    {
        return view('Warehouse/returnBarang/indexImportBB');
    }
    ...
    public function all()
    {
        ...
        $condition = [
            ...
            "pengembalian_barang.type_return" => "IMPORT BAKU",
        ];
    ...
    public function print($id)
    {
        ...
        $data = [
            ...
            'dataPengembalianBarang' => $dataPengembalianBarang,
            'dataPengembalianBarangDetail' => $dataPengembalianBarangDetail,
            'title' => "Retur Pembelian Import Bahan Baku"
        ];
