...
class RasioBaksoController extends BaseController
{
    protected $token;
    ...
    public function index()
    {
        ...
        return view('Accounting/rasio/RatioBakso/index', $data);
    }
    ...
    public function createRasio()
    {
        ...
        return view('Accounting/rasio/RatioBakso/form', $data);
    }
    ...
    public function load_content()
    {
        ...
        if (in_array($page, $validPages)) {
            return view('Accounting/rasio/RatioBakso/' . $page, $data);
        } else {
