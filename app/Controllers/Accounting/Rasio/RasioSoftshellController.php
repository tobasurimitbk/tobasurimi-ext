...
class RasioSoftshellController extends BaseController
{
    protected $token;
    ...
    public function index()
    {
        ...
        return view('Accounting/rasio/RatioSoftShellCrab/index', $data);
    }
    ...
    public function createRasio()
    {
        ...
        return view('Accounting/rasio/RatioSoftShellCrab/form', $data);
    }
    ...
    public function load_content()
    {
        ...
        if (in_array($page, $validPages)) {
            return view('Accounting/rasio/RatioSoftShellCrab/' . $page, $data);
        } else {
