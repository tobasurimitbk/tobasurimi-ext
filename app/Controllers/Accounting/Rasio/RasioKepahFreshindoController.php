...
class RasioKepahFreshindoController extends BaseController
{
    protected $token;
    ...
    public function index()
    {
        ...
        return view('Accounting/rasio/RasioKepahFreshindo/index', $data);
    }
    ...
    public function createRasio()
    {
        ...
        return view('Accounting/rasio/RasioKepahFreshindo/form', $data);
    }
    ...
    public function load_content()
    {
        ...
        if (in_array($page, $validPages)) {
            return view('Accounting/rasio/RasioKepahFreshindo/' . $page, $data);
        } else {
