...
class RasioStuffcrabmeatController extends BaseController
{
    protected $token;
    ...
    public function index()
    {
        ...
        return view('Accounting/rasio/RatioStuffCrabMeat/index', $data);
    }
    ...
    public function createRasio()
    {
        ...
        return view('Accounting/rasio/RatioStuffCrabMeat/form', $data);
    }
    ...
    public function load_content()
    {
        ...
        if (in_array($page, $validPages)) {
            return view('Accounting/rasio/RatioStuffCrabMeat/' . $page, $data);
        } else {
