...
class RasioBabyOctopusFreshController extends BaseController
{
    protected $token;
    ...
    public function index()
    {
        ...
        return view('Accounting/rasio/RatioBabyOctopusFresh/index', $data);
    }
    ...
    public function createRasio()
    {
        ...
        return view('Accounting/rasio/RatioBabyOctopusFresh/form', $data);
    }
    ...
    public function getCost()
    {
        ...
        $tanggal_akhir = date('Y-m-d', strtotime(str_replace('/', '-', $this->request->getVar('tanggal_akhir'))));
        $data = [
            'setting_costing_details.company_id' => $this->this_company_id,
            'setting_costing_details.divisi_id' => $this->request->getVar('department'),
        ];

        $settingCosting = $this->settingCosting->getSettingCosting($data);
    ...
    public function load_content()
    {
        ...
        if (in_array($page, $validPages)) {
            return view('Accounting/rasio/RatioBabyOctopusFresh/' . $page, $data);
        } else {
