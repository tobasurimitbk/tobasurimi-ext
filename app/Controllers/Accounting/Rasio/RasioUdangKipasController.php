...
class RasioUdangKipasController extends BaseController
{
    protected $token;
    ...
    public function index()
    {
        ...
        return view('Accounting/rasio/RatioUdangKipas/index', $data);
    }
    ...
    public function createRasio()
    {
        ...
        return view('Accounting/rasio/RatioUdangKipas/form', $data);
    }
    ...
    public function load_content()
    {
        ...
        if (in_array($page, $validPages)) {
            return view('Accounting/rasio/RatioUdangKipas/' . $page, $data);
        } else {
