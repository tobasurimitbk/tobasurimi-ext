...
$routes->get('/employee/sync-internal', 'Master\Employee::syncInternalEmployee', ['filter' => 'Auth']);
...
$routes->get('/panjar-supplier/all', 'Pembayaran\PanjarSupplier::allPanjarPinjamanSupplier', ['filter' => 'Auth']);
$routes->get('/panjar-supplier/id/(:segment)', 'Pembayaran\PanjarSupplier::getByIdPanjarPinjamanSupplier/$1', ['filter' => 'Auth']);
...
$routes->get('/order-form-lokal/export-excel', 'SalesLokal\OrderForm::exportExcel', ['filter' => 'Auth']);
...
// $routes->get('/surat-jalan/generate', 'SalesLokal\SuratJalan::generateSuratJalanDetail', ['filter' => 'Auth']);
...
$routes->post('/biaya-eskpor/update-status-posting', 'BiayaExim\BiayaEskpor\BiayaEskpor::updateStatusPosting', ['filter' => 'Auth']);
...
$routes->post('/biaya-impor/update-status-posting', 'BiayaExim\BiayaImpor\BiayaImpor::updateStatusPosting', ['filter' => 'Auth']);
...
$routes->post('/biaya-lokal/update-status-posting', 'BiayaExim\BiayaLokal\BiayaLokal::updateStatusPosting', ['filter' => 'Auth']);
...
$routes->get('barang-bahan-penolong/export-histori-supplier', 'Warehouse\Barang::exportHistoriHargaPOBahanPenolongBySupplier', ['filter' => 'Auth']);
...
$routes->get('/jasa-vendor-out-kepiting-kukus', 'JasaVendor\JasaVendorOutKepitingKukus::index', ['filter' => 'Auth']);
$routes->get('/jasa-vendor-out-kepiting-kukus/all', 'JasaVendor\JasaVendorOutKepitingKukus::all', ['filter' => 'Auth']);
$routes->get('/jasa-vendor-out-kepiting-kukus/id/(:segment)', 'JasaVendor\JasaVendorOutKepitingKukus::detail/$1', ['filter' => 'Auth']);
$routes->get('/jasa-vendor-out-kepiting-kukus/create', 'JasaVendor\JasaVendorOutKepitingKukus::create', ['filter' => 'Auth']);
$routes->get('/jasa-vendor-out-kepiting-kukus/search-barang', 'JasaVendor\JasaVendorOutKepitingKukus::searchBarang', ['filter' => 'Auth']);
$routes->get('/jasa-vendor-out-kepiting-kukus/search-master-barang', 'JasaVendor\JasaVendorOutKepitingKukus::searchMasterBarang', ['filter' => 'Auth']);
$routes->post('/jasa-vendor-out-kepiting-kukus/delete', 'JasaVendor\JasaVendorOutKepitingKukus::delete', ['filter' => 'Auth']);
$routes->post('/jasa-vendor-out-kepiting-kukus/posting', 'JasaVendor\JasaVendorOutKepitingKukus::posting', ['filter' => 'Auth']);
$routes->post('/jasa-vendor-out-kepiting-kukus/unposting', 'JasaVendor\JasaVendorOutKepitingKukus::unPosting', ['filter' => 'Auth']);
$routes->post('/jasa-vendor-out-kepiting-kukus/close', 'JasaVendor\JasaVendorOutKepitingKukus::close', ['filter' => 'Auth']);
$routes->post('/jasa-vendor-out-kepiting-kukus/save', 'JasaVendor\JasaVendorOutKepitingKukus::createAction', ['filter' => 'Auth']);
$routes->post('/jasa-vendor-out-kepiting-kukus/update', 'JasaVendor\JasaVendorOutKepitingKukus::updateAction', ['filter' => 'Auth']);
$routes->post('/jasa-vendor-out-kepiting-kukus/posting', 'JasaVendor\JasaVendorOutKepitingKukus::posting', ['filter' => 'Auth']);
$routes->post('/jasa-vendor-out-kepiting-kukus/unposting', 'JasaVendor\JasaVendorOutKepitingKukus::unPosting', ['filter' => 'Auth']);

// JASA VENDOR IN - KEPITING KUKUS
$routes->get('/jasa-vendor-in-kepiting-kukus/get-jasa-vendor-in-no', 'JasaVendor\JasaVendorInKepitingKukus::getJasaVendorInNo', ['filter' => 'Auth']);
$routes->get('/jasa-vendor-in-kepiting-kukus', 'JasaVendor\JasaVendorInKepitingKukus::index', ['filter' => 'Auth']);
$routes->get('/jasa-vendor-in-kepiting-kukus/all', 'JasaVendor\JasaVendorInKepitingKukus::all', ['filter' => 'Auth']);
$routes->get('/jasa-vendor-in-kepiting-kukus/print-filter', 'JasaVendor\JasaVendorInKepitingKukus::printFilter', ['filter' => 'Auth']);
$routes->get('/jasa-vendor-in-kepiting-kukus/id/(:segment)', 'JasaVendor\JasaVendorInKepitingKukus::detail/$1', ['filter' => 'Auth']);
$routes->get('/jasa-vendor-in-kepiting-kukus/create', 'JasaVendor\JasaVendorInKepitingKukus::create', ['filter' => 'Auth']);
$routes->get('/jasa-vendor-in-kepiting-kukus/search-barang', 'JasaVendor\JasaVendorInKepitingKukus::searchBarang', ['filter' => 'Auth']);
...
$routes->get('/jasa-vendor-in-kepiting-kukus/print/(:segment)', 'JasaVendor\JasaVendorInKepitingKukus::print/$1', ['filter' => 'Auth']);
...
$routes->get('/jasa-vendor-in-kepiting-kukus/list-barang-masuk', 'JasaVendor\JasaVendorInKepitingKukus::dropdownListBarangMasuk', ['filter' => 'Auth']);
$routes->get('/jasa-vendor-in-kepiting-kukus/divisi', 'JasaVendor\JasaVendorInKepitingKukus::dropdownDivisi', ['filter' => 'Auth']);
$routes->get('/jasa-vendor-in-kepiting-kukus/warehouse', 'JasaVendor\JasaVendorInKepitingKukus::dropdownWarehouse', ['filter' => 'Auth']);
...
$routes->get('/pengeluaran-lokal/list-stock-dokumen-bc', 'Stuffing\Lokal::getListStockByStockID', ['filter' => 'Auth']);
...
$routes->get('/penerimaan-barang-broken/get-po', 'Warehouse\PenerimaanBarangBroken::getListPO', ['filter' => 'Auth']);
...
$routes->post('/penerimaan-barang-broken/posting', 'Warehouse\PenerimaanBarangBroken::posting', ['filter' => 'Auth']);
...
$routes->get('/penerimaan-barang-broken/generate', 'Warehouse\PenerimaanBarangBroken::generatePenerimaanBarangBroken', ['filter' => 'Auth']);
...
$routes->get('/update-stock-bahan-baku/list-barang-po-kotor', 'Warehouse\UpdateStockBahanBaku::getListStockById', ['filter' => 'Auth']);
...
// form request action action
$routes->get('/form-request-action', 'HR\FormRequestAction::index', ['filter' => 'Auth']);
$routes->get('/form-request-action/get', 'HR\FormRequestAction::get', ['filter' => 'Auth']);
$routes->get('/form-request-action/all', 'HR\FormRequestAction::all', ['filter' => 'Auth']);
$routes->post('/form-request-action/save', 'HR\FormRequestAction::save', ['filter' => 'Auth']);
$routes->post('/form-request-action/update', 'HR\FormRequestAction::update', ['filter' => 'Auth']);
$routes->post('/form-request-action/delete', 'HR\FormRequestAction::delete', ['filter' => 'Auth']);
$routes->get('/form-request-action/get-no', 'HR\FormRequestAction::getNo', ['filter' => 'Auth']);
$routes->get('/form-request-action/print', 'HR\FormRequestAction::print', ['filter' => 'Auth']);
...
$routes->get('/ratio-baby-octopus-fresh', 'Accounting\Rasio\RasioBabyOctopusFreshController::index', ['filter' => 'Auth']);
$routes->get('/ratio-baby-octopus-fresh/create', 'Accounting\Rasio\RasioBabyOctopusFreshController::createRasio', ['filter' => 'Auth']);
$routes->get('/ratio-baby-octopus-fresh/get-barang-digunakan', 'Accounting\Rasio\RasioBabyOctopusFreshController::getRasioBarangDigunakan', ['filter' => 'Auth']);
$routes->get('/ratio-baby-octopus-fresh/get-barang-digunakan-jadi', 'Accounting\Rasio\RasioBabyOctopusFreshController::getRasioBarangDigunakanJadi', ['filter' => 'Auth']);
$routes->get('/ratio-baby-octopus-fresh/get-saldo-akhir', 'Accounting\Rasio\RasioBabyOctopusFreshController::getSaldoAkhir', ['filter' => 'Auth']);
$routes->get('/ratio-baby-octopus-fresh/get-saldo-awal', 'Accounting\Rasio\RasioBabyOctopusFreshController::getSaldoAwal', ['filter' => 'Auth']);
$routes->get('/ratio-baby-octopus-fresh/get-saldo-adjusment', 'Accounting\Rasio\RasioBabyOctopusFreshController::getSaldoAdjusment', ['filter' => 'Auth']);
$routes->get('/ratio-baby-octopus-fresh/get-saldo-jual', 'Accounting\Rasio\RasioBabyOctopusFreshController::getSaldoJual', ['filter' => 'Auth']);
$routes->get('/ratio-baby-octopus-fresh/get-saldo-trimming', 'Accounting\Rasio\RasioBabyOctopusFreshController::getSaldoTrimming', ['filter' => 'Auth']);
$routes->get('/ratio-baby-octopus-fresh/get-barang-jadi', 'Accounting\Rasio\RasioBabyOctopusFreshController::getRasioBarangJadi', ['filter' => 'Auth']);

$routes->get('/ratio-baby-octopus-fresh/get-material-i', 'Accounting\Rasio\RasioBabyOctopusFreshController::getRawMaterialI', ['filter' => 'Auth']);

$routes->get('/ratio-baby-octopus-fresh/get-barang-digunakan-penolong', 'Accounting\Rasio\RasioBabyOctopusFreshController::getRasioBarangDigunakanPenolong', ['filter' => 'Auth']);
$routes->get('/ratio-baby-octopus-fresh/get-jurnal', 'Accounting\Rasio\RasioBabyOctopusFreshController::getDataJurnal', ['filter' => 'Auth']);
$routes->get('/ratio-baby-octopus-fresh/get-cost', 'Accounting\Rasio\RasioBabyOctopusFreshController::getCost', ['filter' => 'Auth']);
$routes->get('/ratio-baby-octopus-fresh/all', 'Accounting\Rasio\RasioBabyOctopusFreshController::allRasio', ['filter' => 'Auth']);
$routes->get('/ratio-baby-octopus-fresh/id/(:segment)', 'Accounting\Rasio\RasioBabyOctopusFreshController::getById/$1', ['filter' => 'Auth']);
$routes->post('/ratio-baby-octopus-fresh/save', 'Accounting\Rasio\RasioBabyOctopusFreshController::saveRasio', ['filter' => 'Auth']);
$routes->post('/ratio-baby-octopus-fresh/update', 'Accounting\Rasio\RasioBabyOctopusFreshController::updateRasio', ['filter' => 'Auth']);
$routes->post('/ratio-baby-octopus-fresh/delete', 'Accounting\Rasio\RasioBabyOctopusFreshController::deleteRasio', ['filter' => 'Auth']);
$routes->post('/ratio-baby-octopus-fresh/get', 'Accounting\Rasio\RasioBabyOctopusFreshController::get', ['filter' => 'Auth']);
$routes->get('/ratio-baby-octopus-fresh/load_content', 'Accounting\Rasio\RasioBabyOctopusFreshController::load_content', ['filter' => 'Auth']);

$routes->get('/ratio-cumi-cumi-fresh', 'Accounting\Rasio\RasioCumiCumiFreshController::index', ['filter' => 'Auth']);
$routes->get('/ratio-cumi-cumi-fresh/create', 'Accounting\Rasio\RasioCumiCumiFreshController::createRasio', ['filter' => 'Auth']);
$routes->get('/ratio-cumi-cumi-fresh/get-barang-digunakan', 'Accounting\Rasio\RasioCumiCumiFreshController::getRasioBarangDigunakan', ['filter' => 'Auth']);
$routes->get('/ratio-cumi-cumi-fresh/get-barang-digunakan-jadi', 'Accounting\Rasio\RasioCumiCumiFreshController::getRasioBarangDigunakanJadi', ['filter' => 'Auth']);
$routes->get('/ratio-cumi-cumi-fresh/get-saldo-akhir', 'Accounting\Rasio\RasioCumiCumiFreshController::getSaldoAkhir', ['filter' => 'Auth']);
$routes->get('/ratio-cumi-cumi-fresh/get-saldo-awal', 'Accounting\Rasio\RasioCumiCumiFreshController::getSaldoAwal', ['filter' => 'Auth']);
$routes->get('/ratio-cumi-cumi-fresh/get-saldo-adjusment', 'Accounting\Rasio\RasioCumiCumiFreshController::getSaldoAdjusment', ['filter' => 'Auth']);
$routes->get('/ratio-cumi-cumi-fresh/get-saldo-jual', 'Accounting\Rasio\RasioCumiCumiFreshController::getSaldoJual', ['filter' => 'Auth']);
$routes->get('/ratio-cumi-cumi-fresh/get-saldo-trimming', 'Accounting\Rasio\RasioCumiCumiFreshController::getSaldoTrimming', ['filter' => 'Auth']);
$routes->get('/ratio-cumi-cumi-fresh/get-barang-jadi', 'Accounting\Rasio\RasioCumiCumiFreshController::getRasioBarangJadi', ['filter' => 'Auth']);

$routes->get('/ratio-cumi-cumi-fresh/get-material-i', 'Accounting\Rasio\RasioCumiCumiFreshController::getRawMaterialI', ['filter' => 'Auth']);

$routes->get('/ratio-cumi-cumi-fresh/get-barang-digunakan-penolong', 'Accounting\Rasio\RasioCumiCumiFreshController::getRasioBarangDigunakanPenolong', ['filter' => 'Auth']);
$routes->get('/ratio-cumi-cumi-fresh/get-jurnal', 'Accounting\Rasio\RasioCumiCumiFreshController::getDataJurnal', ['filter' => 'Auth']);
$routes->get('/ratio-cumi-cumi-fresh/get-cost', 'Accounting\Rasio\RasioCumiCumiFreshController::getCost', ['filter' => 'Auth']);
$routes->get('/ratio-cumi-cumi-fresh/all', 'Accounting\Rasio\RasioCumiCumiFreshController::allRasio', ['filter' => 'Auth']);
$routes->get('/ratio-cumi-cumi-fresh/id/(:segment)', 'Accounting\Rasio\RasioCumiCumiFreshController::getById/$1', ['filter' => 'Auth']);
$routes->post('/ratio-cumi-cumi-fresh/save', 'Accounting\Rasio\RasioCumiCumiFreshController::saveRasio', ['filter' => 'Auth']);
$routes->post('/ratio-cumi-cumi-fresh/update', 'Accounting\Rasio\RasioCumiCumiFreshController::updateRasio', ['filter' => 'Auth']);
$routes->post('/ratio-cumi-cumi-fresh/delete', 'Accounting\Rasio\RasioCumiCumiFreshController::deleteRasio', ['filter' => 'Auth']);
$routes->post('/ratio-cumi-cumi-fresh/get', 'Accounting\Rasio\RasioCumiCumiFreshController::get', ['filter' => 'Auth']);
$routes->get('/ratio-cumi-cumi-fresh/load_content', 'Accounting\Rasio\RasioCumiCumiFreshController::load_content', ['filter' => 'Auth']);

$routes->get('/ratio-kepah-freshindo', 'Accounting\Rasio\RasioKepahFreshindoController::index', ['filter' => 'Auth']);
$routes->get('/ratio-kepah-freshindo/create', 'Accounting\Rasio\RasioKepahFreshindoController::createRasio', ['filter' => 'Auth']);
$routes->get('/ratio-kepah-freshindo/get-barang-digunakan', 'Accounting\Rasio\RasioKepahFreshindoController::getRasioBarangDigunakan', ['filter' => 'Auth']);
$routes->get('/ratio-kepah-freshindo/get-barang-digunakan-jadi', 'Accounting\Rasio\RasioKepahFreshindoController::getRasioBarangDigunakanJadi', ['filter' => 'Auth']);
$routes->get('/ratio-kepah-freshindo/get-saldo-akhir', 'Accounting\Rasio\RasioKepahFreshindoController::getSaldoAkhir', ['filter' => 'Auth']);
$routes->get('/ratio-kepah-freshindo/get-saldo-awal', 'Accounting\Rasio\RasioKepahFreshindoController::getSaldoAwal', ['filter' => 'Auth']);
$routes->get('/ratio-kepah-freshindo/get-saldo-adjusment', 'Accounting\Rasio\RasioKepahFreshindoController::getSaldoAdjusment', ['filter' => 'Auth']);
$routes->get('/ratio-kepah-freshindo/get-saldo-jual', 'Accounting\Rasio\RasioKepahFreshindoController::getSaldoJual', ['filter' => 'Auth']);
$routes->get('/ratio-kepah-freshindo/get-saldo-trimming', 'Accounting\Rasio\RasioKepahFreshindoController::getSaldoTrimming', ['filter' => 'Auth']);
$routes->get('/ratio-kepah-freshindo/get-barang-jadi', 'Accounting\Rasio\RasioKepahFreshindoController::getRasioBarangJadi', ['filter' => 'Auth']);

$routes->get('/ratio-kepah-freshindo/get-material-i', 'Accounting\Rasio\RasioKepahFreshindoController::getRawMaterialI', ['filter' => 'Auth']);

$routes->get('/ratio-kepah-freshindo/get-barang-digunakan-penolong', 'Accounting\Rasio\RasioKepahFreshindoController::getRasioBarangDigunakanPenolong', ['filter' => 'Auth']);
$routes->get('/ratio-kepah-freshindo/get-jurnal', 'Accounting\Rasio\RasioKepahFreshindoController::getDataJurnal', ['filter' => 'Auth']);
$routes->get('/ratio-kepah-freshindo/get-cost', 'Accounting\Rasio\RasioKepahFreshindoController::getCost', ['filter' => 'Auth']);
$routes->get('/ratio-kepah-freshindo/all', 'Accounting\Rasio\RasioKepahFreshindoController::allRasio', ['filter' => 'Auth']);
$routes->get('/ratio-kepah-freshindo/id/(:segment)', 'Accounting\Rasio\RasioKepahFreshindoController::getById/$1', ['filter' => 'Auth']);
$routes->post('/ratio-kepah-freshindo/save', 'Accounting\Rasio\RasioKepahFreshindoController::saveRasio', ['filter' => 'Auth']);
$routes->post('/ratio-kepah-freshindo/update', 'Accounting\Rasio\RasioKepahFreshindoController::updateRasio', ['filter' => 'Auth']);
$routes->post('/ratio-kepah-freshindo/delete', 'Accounting\Rasio\RasioKepahFreshindoController::deleteRasio', ['filter' => 'Auth']);
$routes->post('/ratio-kepah-freshindo/get', 'Accounting\Rasio\RasioKepahFreshindoController::get', ['filter' => 'Auth']);
$routes->get('/ratio-kepah-freshindo/load_content', 'Accounting\Rasio\RasioKepahFreshindoController::load_content', ['filter' => 'Auth']);
...
$routes->get('/laporan-accounting/jasa-vendor/all', 'Laporan\Accounting\JasaVendor::all', ['filter' => 'Auth']);
...
$routes->get('/laporan-warehouse/purchase-order', 'Laporan\Warehouse\LaporanWarehousePembelian::index', ['filter' => 'Auth']);
$routes->get('/laporan-warehouse/purchase-order/all-purchase-order', 'Laporan\Warehouse\LaporanWarehousePembelian::all', ['filter' => 'Auth']);
$routes->get('/laporan-warehouse/purchase-order/excel', 'Laporan\Warehouse\LaporanWarehousePembelian::exportExcel', ['filter' => 'Auth']);
...
$routes->get('/laporan-sales/sales-per-pelanggan/printPDF/(:segment)/(:segment)/(:segment)/(:segment)', 'Laporan\Penjualan\PenjualanPerPelanggan::printPDF/$1/$2/$3/$4', ['filter' => 'Auth']);
$routes->get('/laporan-sales/sales-per-pelanggan/printExcel/(:segment)/(:segment)/(:segment)/(:segment)', 'Laporan\Penjualan\PenjualanPerPelanggan::printExcel/$1/$2/$3/$4', ['filter' => 'Auth']);
$routes->get('/laporan-sales/sales-per-pelanggan-per-penjual/printPDF/(:segment)/(:segment)/(:segment)/(:segment)', 'Laporan\Penjualan\PenjualanPerPelanggan::printPDFPerPelangganPerPenjual/$1/$2/$3/$4', ['filter' => 'Auth']);
$routes->get('/laporan-sales/sales-per-pelanggan-per-penjual/printExcel/(:segment)/(:segment)/(:segment)/(:segment)', 'Laporan\Penjualan\PenjualanPerPelanggan::printExcelPerPelangganPerPenjual/$1/$2/$3/$4', ['filter' => 'Auth']);

$routes->get('/laporan-sales/rincian-sales-per-pelanggan', 'Laporan\Penjualan\RincianPenjualanPerPelanggan::index', ['filter' => 'Auth']);
$routes->get('/laporan-sales/rincian-sales-per-pelanggan/all', 'Laporan\Penjualan\RincianPenjualanPerPelanggan::allTransaksi', ['filter' => 'Auth']);
$routes->get('/laporan-sales/rincian-sales-per-pelanggan/printPDF/(:segment)/(:segment)/(:segment)/(:segment)', 'Laporan\Penjualan\RincianPenjualanPerPelanggan::LaporanPenjualanPrint/$1/$2/$3/$4', ['filter' => 'Auth']);
$routes->get('/laporan-sales/rincian-sales-per-pelanggan/printExcel/(:segment)/(:segment)/(:segment)/(:segment)', 'Laporan\Penjualan\RincianPenjualanPerPelanggan::exportExcel/$1/$2/$3/$4', ['filter' => 'Auth']);
...
$routes->get('/laporan-sales/rincian-sales-per-barang', 'Laporan\Penjualan\RincianPenjualanPerBarang::index', ['filter' => 'Auth']);
$routes->get('/laporan-sales/rincian-sales-per-barang/all', 'Laporan\Penjualan\RincianPenjualanPerBarang::allTransaksi', ['filter' => 'Auth']);
$routes->get('/laporan-sales/rincian-sales-per-barang/printPDFAll/(:segment)/(:segment)/(:segment)/(:segment)/(:segment)', 'Laporan\Penjualan\RincianPenjualanPerBarang::printPDFAll/$1/$2/$3/$4/$5', ['filter' => 'Auth']);
$routes->get('/laporan-sales/rincian-sales-per-barang/printExcelAll/(:segment)/(:segment)/(:segment)/(:segment)/(:segment)', 'Laporan\Penjualan\RincianPenjualanPerBarang::printExcelAll/$1/$2/$3/$4/$5', ['filter' => 'Auth']);

$routes->get('/laporan-sales/pesanan-sales-per-pelanggan', 'Laporan\Penjualan\PesananPenjualanPerPelanggan::index', ['filter' => 'Auth']);
$routes->get('/laporan-sales/pesanan-sales-per-pelanggan/all', 'Laporan\Penjualan\PesananPenjualanPerPelanggan::allTransaksi', ['filter' => 'Auth']);
$routes->get('/laporan-sales/pesanan-sales-per-pelanggan/printPDF/(:segment)/(:segment)/(:segment)/(:segment)/(:segment)', 'Laporan\Penjualan\PesananPenjualanPerPelanggan::printPDF/$1/$2/$3/$4/$5', ['filter' => 'Auth']);
$routes->get('/laporan-sales/pesanan-sales-per-pelanggan/printExcel/(:segment)/(:segment)/(:segment)/(:segment)/(:segment)', 'Laporan\Penjualan\PesananPenjualanPerPelanggan::printExcel/$1/$2/$3/$4/$5', ['filter' => 'Auth']);

$routes->get('/laporan-sales/return-sales-per-pelanggan', 'Laporan\Penjualan\ReturnPenjualanPerPelanggan::index', ['filter' => 'Auth']);
$routes->get('/laporan-sales/return-sales-per-pelanggan/all', 'Laporan\Penjualan\ReturnPenjualanPerPelanggan::allTransaksi', ['filter' => 'Auth']);
$routes->get('/laporan-sales/return-sales-per-pelanggan/printPDF/(:segment)/(:segment)/(:segment)/(:segment)', 'Laporan\Penjualan\ReturnPenjualanPerPelanggan::printPDF/$1/$2/$3/$4', ['filter' => 'Auth']);
$routes->get('/laporan-sales/return-sales-per-pelanggan/printExcel/(:segment)/(:segment)/(:segment)/(:segment)', 'Laporan\Penjualan\ReturnPenjualanPerPelanggan::printExcel/$1/$2/$3/$4', ['filter' => 'Auth']);

$routes->get('/laporan-sales/return-sales-per-barang', 'Laporan\Penjualan\ReturnPenjualanPerBarang::index', ['filter' => 'Auth']);
$routes->get('/laporan-sales/return-sales-per-barang/all', 'Laporan\Penjualan\ReturnPenjualanPerBarang::allTransaksi', ['filter' => 'Auth']);
$routes->get('/laporan-sales/return-sales-per-barang/printPDF/(:segment)/(:segment)/(:segment)/(:segment)', 'Laporan\Penjualan\ReturnPenjualanPerBarang::printPDF/$1/$2/$3/$4', ['filter' => 'Auth']);
$routes->get('/laporan-sales/return-sales-per-barang/printExcel/(:segment)/(:segment)/(:segment)/(:segment)', 'Laporan\Penjualan\ReturnPenjualanPerBarang::printExcel/$1/$2/$3/$4', ['filter' => 'Auth']);

$routes->get('/laporan-sales/pembelian-per-barang', 'Laporan\Penjualan\PembelianPerBarang::index', ['filter' => 'Auth']);
$routes->get('/laporan-sales/pembelian-per-barang/all', 'Laporan\Penjualan\PembelianPerBarang::allTransaksi', ['filter' => 'Auth']);
$routes->get('/laporan-sales/pembelian-per-barang/printPDFAll/(:segment)/(:segment)/(:segment)/(:segment)', 'Laporan\Penjualan\PembelianPerBarang::printPDFAll/$1/$2/$3/$4', ['filter' => 'Auth']);
$routes->get('/laporan-sales/pembelian-per-barang/printExcelAll/(:segment)/(:segment)/(:segment)/(:segment)', 'Laporan\Penjualan\PembelianPerBarang::printExcelAll/$1/$2/$3/$4', ['filter' => 'Auth']);
$routes->get('/laporan-sales/pembelian-per-barang/printPDFTotal/(:segment)/(:segment)/(:segment)/(:segment)', 'Laporan\Penjualan\PembelianPerBarang::printPDFTotal/$1/$2/$3/$4', ['filter' => 'Auth']);
$routes->get('/laporan-sales/pembelian-per-barang/printExcelTotal/(:segment)/(:segment)/(:segment)/(:segment)', 'Laporan\Penjualan\PembelianPerBarang::printExcelTotal/$1/$2/$3/$4', ['filter' => 'Auth']);
$routes->get('/laporan-sales/pembelian-per-barang/printPDFKuantitas/(:segment)/(:segment)/(:segment)/(:segment)', 'Laporan\Penjualan\PembelianPerBarang::printPDFKuantitas/$1/$2/$3/$4', ['filter' => 'Auth']);
$routes->get('/laporan-sales/pembelian-per-barang/printExcelKuantitas/(:segment)/(:segment)/(:segment)/(:segment)', 'Laporan\Penjualan\PembelianPerBarang::printExcelKuantitas/$1/$2/$3/$4', ['filter' => 'Auth']);
$routes->get('/laporan-sales/pembelian-per-barang/printPDFPemasok/(:segment)/(:segment)/(:segment)/(:segment)', 'Laporan\Penjualan\PembelianPerBarang::printPDFPemasok/$1/$2/$3/$4', ['filter' => 'Auth']);
$routes->get('/laporan-sales/pembelian-per-barang/printExcelPemasok/(:segment)/(:segment)/(:segment)/(:segment)', 'Laporan\Penjualan\PembelianPerBarang::printExcelPemasok/$1/$2/$3/$4', ['filter' => 'Auth']);

$routes->get('/laporan-sales/histori-pesanan-penjualan', 'Laporan\Penjualan\HistoriPesananPenjualan::index', ['filter' => 'Auth']);
$routes->get('/laporan-sales/histori-pesanan-penjualan/all', 'Laporan\Penjualan\HistoriPesananPenjualan::allTransaksi', ['filter' => 'Auth']);
$routes->get('/laporan-sales/histori-pesanan-penjualan/printPDFAll/(:segment)/(:segment)/(:segment)/(:segment)', 'Laporan\Penjualan\HistoriPesananPenjualan::printPDFAll/$1/$2/$3/$4', ['filter' => 'Auth']);
$routes->get('/laporan-sales/histori-pesanan-penjualan/printExcelAll/(:segment)/(:segment)/(:segment)/(:segment)', 'Laporan\Penjualan\HistoriPesananPenjualan::printExcelAll/$1/$2/$3/$4', ['filter' => 'Auth']);

$routes->get('/laporan-sales/histori-pengiriman-pesanan', 'Laporan\Penjualan\HistoriPengirimanPesanan::index', ['filter' => 'Auth']);
$routes->get('/laporan-sales/histori-pengiriman-pesanan/all', 'Laporan\Penjualan\HistoriPengirimanPesanan::allTransaksi', ['filter' => 'Auth']);
$routes->get('/laporan-sales/histori-pengiriman-pesanan/printPDFAll/(:segment)/(:segment)/(:segment)/(:segment)', 'Laporan\Penjualan\HistoriPengirimanPesanan::printPDFAll/$1/$2/$3/$4', ['filter' => 'Auth']);
$routes->get('/laporan-sales/histori-pengiriman-pesanan/printExcelAll/(:segment)/(:segment)/(:segment)/(:segment)', 'Laporan\Penjualan\HistoriPengirimanPesanan::printExcelAll/$1/$2/$3/$4', ['filter' => 'Auth']);

$routes->get('/laporan-sales/sales-invoice-list', 'Laporan\Penjualan\SalesInvoiceList::index', ['filter' => 'Auth']);
$routes->get('/laporan-sales/sales-invoice-list/all', 'Laporan\Penjualan\SalesInvoiceList::allTransaksi', ['filter' => 'Auth']);
$routes->get('/laporan-sales/sales-invoice-list/printPDF/(:segment)/(:segment)/(:segment)/(:segment)', 'Laporan\Penjualan\SalesInvoiceList::LaporanPenjualanPrint/$1/$2/$3/$4', ['filter' => 'Auth']);
$routes->get('/laporan-sales/sales-invoice-list/printExcel/(:segment)/(:segment)/(:segment)/(:segment)', 'Laporan\Penjualan\SalesInvoiceList::exportExcel/$1/$2/$3/$4', ['filter' => 'Auth']);

$routes->get('/laporan-sales/customers-sales-by-items', 'Laporan\Penjualan\CustomersSalesByItems::index', ['filter' => 'Auth']);
