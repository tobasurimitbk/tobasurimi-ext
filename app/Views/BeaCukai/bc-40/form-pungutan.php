                ...
                <table class="table table-bordered nowrap table-hover-tobasurimi dataTable table-list-pungutan" width="100%" cellspacing="0">
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <th style="text-align: center;">Ditangguhkan</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php if (count($barangTarif) != 0) : ?>
                            ...
                            <?php foreach ($pungutanList as $p) : ?>
                                <tr>
                                    ...
                                    <td style="text-align: center;"><?= ($p['tidak_dipungut']) ?></td>
                                    <td style="text-align: center;"><?= ($p['dibebaskan']) ?></td>
                                    <td style="text-align: center;"><?= ($p['ditangguhkan']) ?></td>
                                </tr>
                            <?php endforeach; ?>
