            ...
            <form id="form-pernyataan">
                <div class="row">
                    <div class="col-sm mt-1">
                        ...
                        <div class="mt-1">
                            <div class="form-floating mb-3">
                                <input value="<?= !empty($bc40) ? ($bc40['tanggal_ttd'] == null ? date('d/m/Y') : date('d/m/Y', strtotime($bc40['tanggal_ttd']))) : date('d/m/Y', strtotime(date('Y-m-d'))) ?>" id="pernyataan_tanggal" name="pernyataan_tanggal" type="text" class="form-control pernyataan_tanggal" placeholder="">
                                <label>Tanggal</label>
                            </div>
                        </div>
                    </div>
        ...
        if ($('#form-pernyataan').valid()) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "<?= base_url("bea-cukai-bc-40/id/pernyataan"); ?>",
                        data: formData,
