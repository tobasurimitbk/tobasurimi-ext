            ...
            <div class="row justify-content-start row-col-spp">
                <div class="col-md-3 mb-3">
                    ...
                    <div class="input-group input-group-password">
                        <input autocomplete="one-time-code" class="form-control input-picker mulaiTanggalBC41" id="mulaiTanggalBC41" name="mulaiTanggalBC41" placeholder="Mulai Tanggal" value="<?= date('d/m/Y') ?>">
...
<script>
    ...
    function unPostingAction(id) {
        Swal.fire({
            icon: 'question',
            title: 'Un Posting Dokumen BC 4.1 ?',
            confirmButtonColor: '#4e73df',
            cancelButtonColor: '#d33',
            showCancelButton: true,
            reverseButtons: true,
            ...
            if (result.isConfirmed) {
                ...
                formData.append("id", id);
                $.ajax({
                    url: `<?= base_url("bea-cukai-bc-41/unposting"); ?>`,
                    method: "POST",
                    data: formData,
                    beforeSend: function(xhr) {
                        setLoading();
