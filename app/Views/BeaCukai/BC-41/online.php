...
<section class="section">
    <div class="section-header">
        <h1>Status Respon Dokumen BC 4.1</h1>
        <a href="<?= base_url('bea-cukai-bc-41') ?>" type="button" class="btn btn-show-form btn-add float-right">
...
<script>
    $(document).ready(function() {
        ...
        function getList() {
            $.ajax({
                url: `<?= base_url('bea-cukai-bc-41/all-online'); ?>`,
                method: "GET",
                beforeSend: function() {
                    setLoading();
                },
