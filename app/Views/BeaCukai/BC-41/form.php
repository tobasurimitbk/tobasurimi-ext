                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-floating mb-3 mt-1" style="height: 50px;">
                            <select <?= !empty($bc41) ? ($bc41['status_posting'] == "1" ? "disabled" : "") : '' ?> class="form-select sales_order_lain_id" id="sales_order_lain_id" name="sales_order_lain_id" aria-label="Floating label select example">
                                <option value=""></option>
                                <?php foreach ($salesOrderLain as $s) : ?>
                                    <option <?= (!empty($bc41) ? ($bc41['sales_order_lain_id'] == $s['id'] ? 'selected' : '') : '') ?> data-sales_order_lain_id="<?= encrypt($s['id']) ?>" data-nama_customer="<?= $s['nama_customer'] ?>" data-country_name="<?= $s['country_name'] ?>" data-alamat_customer="<?= $s['alamat_customer'] ?>" data-tanggal_sales_order="<?= date('d/m/Y', strtotime($s['tanggal'])) ?>" data-divisi="<?= $s['divisi'] ?>" data-warehouse_name="<?= $s['warehouse_name'] ?>" data-keterangan="<?= $s['keterangan'] ?>" value="<?= $s['id'] ?>">
                                        <?= $s['no_sales_order'] ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                    ...
                    <div class="col-sm-4">
                        <div class="form-floating mb-3" style="height: 50px;">
                            <input disabled placeholder="Nama Customer" value="<?= !empty($bc41) ? $bc41['nama_customer'] : '' ?>" class="form-control nama_customer" id="nama_customer" aria-label="Floating label select example" />
                            <label for="floatingInput" style="z-index: 1;">Nama Customer</label>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-floating mb-3" style="height: 50px;">
                            <input disabled placeholder="Negara" value="<?= !empty($bc41) ? $bc41['country_name'] : '' ?>" class="form-control country_name" id="country_name" aria-label="Floating label select example" />
                            <label for="floatingInput" style="z-index: 1;">Negara</label>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-floating mb-3" style="height: 50px;">
                            <input disabled placeholder="Company Asal" value="<?= !empty($bc41) ? $bc41['alamat_customer'] : '' ?>" class="form-control alamat_customer" id="alamat_customer" aria-label="Floating label select example" />
                    ...
                    <div class="col-sm-4">
                        <div class="input-group input-group-password">
                            <div class="form-floating mb-3">
                                <input disabled <?= !empty($bc41) ? ($bc41['status_posting'] == "1" ? "disabled" : "") : '' ?> value="<?= !empty($bc41) ? $bc41['no_daftar'] : "" ?>" autocomplete="one-time-code" type="text" class="form-control tanggal_sales_order" id="tanggal_sales_order" name="tanggal_sales_order" placeholder="No Daftar">
                    ...
                    <div class="col-sm-4">
                        <div class="form-floating mb-3">
                            <input disabled <?= !empty($bc41) ? ($bc41['status_posting'] == "1" ? "disabled" : "") : '' ?> value="<?= !empty($bc41) ? $bc41['no_daftar'] : "" ?>" autocomplete="one-time-code" type="text" class="form-control divisi" id="divisi" name="divisi" placeholder="Departemen">
                            <label for="floatingInput">Departemen</label>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-floating mb-3">
                            <input disabled <?= !empty($bc41) ? ($bc41['status_posting'] == "1" ? "disabled" : "") : '' ?> value="<?= !empty($bc41) ? $bc41['no_daftar'] : "" ?>" autocomplete="one-time-code" type="text" class="form-control warehouse_name" id="warehouse_name" name="warehouse_name" placeholder="Warehouse">
                            <label for="floatingInput">Warehouse</label>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-floating mb-3">
                            <input disabled <?= !empty($bc41) ? ($bc41['status_posting'] == "1" ? "disabled" : "") : '' ?> value="<?= !empty($bc41) ? $bc41['no_daftar'] : "" ?>" autocomplete="one-time-code" type="text" class="form-control keterangan" id="keterangan" name="keterangan" placeholder="Keterangan">
...
<script>
    ...
    <?php if (!empty($bc41)) : ?>
        $.ajax({
            ...
            method: "GET",
            data: {
                sales_order_lain_id: "<?= encrypt($bc41['sales_order_lain_id']) ?>"
            },
            dataType: "json",
