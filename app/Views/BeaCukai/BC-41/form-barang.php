                    ...
                    <table class="table table-bordered nowrap table-hover-tobasurimi dataTable table-list-lpb" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <?php foreach ($barang as $b) : ?>
                                <?php $detailBarang = $bc41Model->detailBarang($bc41['id'], $b['kode_barang'], $bc41['sales_order_lain_id']); ?>
...
<script>
    ...
    $('.table-list-lpb tbody').on('click', 'tr', function() {
        ...
        window.location.replace("<?= base_url('bea-cukai-bc-41/id/barang/') ?>" + bc25Id + '/' + kodeBarang);
    });
</script>
