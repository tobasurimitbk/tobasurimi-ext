            ...
            <form id="form-pernyataan">
                <div class="row">
                    <div class="col-sm mt-1">
                        ...
                        <div class="mt-1">
                            <div class="form-floating mb-3">
                                <input value="<?= !empty($bc23) ?  $bc23['kota_ttd'] : '' ?>" id="pernyatan_tempat" name="pernyatan_tempat" type="text" class="form-control pernyatan_tempat" placeholder="">
                                <label>Tempat</label>
                            </div>
                        </div>
                        <div class="mt-1">
                    ...
                    <div class="col-sm mt-1">
                        ...
                        <div class="mt-1">
                            <div class="form-floating mb-3">
                                <input value="<?= !empty($bc23) ?  $bc23['nama_ttd'] : '' ?>" id="pernyatan_nama" name="pernyatan_nama" type="text" class="form-control pernyatan_nama" placeholder="">
                                <label>Nama</label>
                            </div>
                        </div>
                        <div class="mt-1">
                            <div class="form-floating mb-3">
                                <input value="<?= !empty($bc23) ?  $bc23['jabatan_pengusaha_ttd'] : '' ?>" id="pernyatan_jabatan" name="pernyatan_jabatan" type="text" class="form-control pernyatan_jabatan" placeholder="">
                                <label>Jabatan</label>
                            </div>
                        </div>
                    </div>
