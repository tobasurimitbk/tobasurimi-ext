...
<section class="section section-form">
    ...
    <div class="section-header">
        ...
        <div class="col-button-tambah-spp">
            ...
            <a class="btn btn-info btn-print float-right text-white" href="<?= base_url('bea-cukai-bc-23/id/header/' . encrypt($bcPo['id'])) ?>">
                Form Ceisa
            </a>
                    ...
                    <div class="col-sm-4">
                        <div class="form-floating mb-3 mt-1" style="height: 50px;">
                            <select disabled class="form-select" id="po_type" name="" aria-label="Floating label select example">
                                <option value=""></option>
                                <option <?= $bcPo['po_type'] == "IMPORT BAKU" ? 'selected' : '' ?> value="LOKAL BAKU">PO IMPORT BAHAN BAKU</option>
                                <option <?= $bcPo['po_type'] == "IMPORT PENOLONG" ? 'selected' : '' ?> value="LOKAL PENOLONG">PO IMPORT BAHAN PENOLONG</option>
...
<script>
    ...
    <?php foreach ($daftarPoUsed as $d) : ?>
        listDataSelected.push({
            ...
            qty_lpb: "<?= number_format($d['qty_lpb'], 2) ?>",
            qty_lpb_konversi: "<?= number_format($d['qty_lpb_konversi'], 2) ?>",
            qty_po: "<?= number_format($d['qty_po'], 2) ?>",
            ...
            if ($('.create-form').valid()) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: "<?= base_url("bea-cukai-bc-23/po/update"); ?>",
                            data: data,
