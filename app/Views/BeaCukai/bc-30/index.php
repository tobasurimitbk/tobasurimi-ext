            ...
            <?php if ($akunCeisa != null) : ?>
                <?php if ($akunCeisa['status_integrasi']) : ?>
                    ...
                    <?php if (can("Bea Cukai", "BC 3.0", "c")) : ?>
                        <a href="<?= base_url('bea-cukai-bc-30/create') ?>" type="button" class="btn btn-success float-right">
...
<script>
    ...
    $('.mulaiTanggalBC30, .selesaiTanggalBC30,.statusPosting,.tipeSalesOrder').change(function() {
        table.ajax.reload();
    });
