...
<section class="section">
    <div class="section-header">
        <h1>Status Respon Dokumen BC 3.0</h1>
        <a href="<?= base_url('bea-cukai-bc-30') ?>" type="button" class="btn btn-show-form btn-add float-right">
...
<script>
    $(document).ready(function() {
        ...
        function getList() {
            $.ajax({
                url: `<?= base_url('bea-cukai-bc-30/all-online'); ?>`,
                method: "GET",
                beforeSend: function() {
                    setLoading();
                },
