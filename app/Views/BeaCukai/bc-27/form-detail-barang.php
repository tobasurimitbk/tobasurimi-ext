        ...
        <div class="card-body">
            ...
            <div class="detail-barang-form-view">
                <div class="mt-3">
                    ...
                    <a class="btn btn-danger float-right" href="<?= base_url('bea-cukai-bc-27/id/barang/' . encrypt($bc27['id'])) ?>" style="margin-right: 8px;">
                        Batal
                    </a>
                </div>
                ...
                <table width="100%" class="mb-3">
                    <tbody>
                        ...
                        <tr style="color: black;">
                            ...
                            <td width="10px">:</td>
                            <td><?= $barang['barangDetail']['barang'] ?></td>
                        </tr>
                    </tbody>
                </table>
                ...
                <form id="form-barang-detail">
                    <div class="row">
                        ...
                        <div class="col-sm-4 mt-1">
                            ...
                            <div class="mt-1">
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-floating mb-2">
                                            <input value="<?= $barang['bcDetail']->jumlahSatuan == ""  ? '-' : $barang['bcDetail']->jumlahSatuan ?>" id="jumlahSatuan" name="jumlahSatuan" type="text" class="form-control jumlahSatuan" placeholder="">
                            ...
                            <div class="mt-3">
                                <div class="form-floating mb-3">
                                    <input value="" id="volume" name="volume" type="text" class="form-control volume" placeholder="">
                                    <label>Volume (M3)</label>
                                </div>
                            </div>
                            <div class="mt-3">
                                <div class="form-floating mb-3">
                                    <input value="<?= $barang['bcDetail']->netto == ""  ? '-' : $barang['bcDetail']->netto ?>" id="netto" name="netto" type="text" class="form-control netto" placeholder="">
                        ...
                        <div class="col-sm-4 mt-1">
                            ...
                            <div class="mt-1">
                                <div class="form-floating mb-3">
                                    <input readonly id="cif" name="cif" type="text" class="form-control cif" value="<?= $barang['bcDetail']->cif == ""  ? '-' : $barang['bcDetail']->cif ?>" placeholder="">
                                    <label>Nilai CIF</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input readonly id="hargaEkspor" name="hargaEkspor" type="text" class="form-control hargaEkspor" value="<?= $barang['bcDetail']->hargaEkspor == ""  ? '-' : $barang['bcDetail']->hargaEkspor ?>" placeholder="">
            ...
            if (dataSeriBarang.length == 0) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: "<?= base_url("bea-cukai-bc-27/id/barang/bahan-baku-create"); ?>",
                            data: formData,
                            beforeSend: function(xhr) {
                                xhr.setRequestHeader('X-CSRF-Token', csrf.val());
                                setLoading();
        ...
        if ($('#form-pungutan').valid()) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "<?= base_url("bea-cukai-bc-27/id/barang/pungutan-create"); ?>",
                        data: formData,
                        beforeSend: function(xhr) {
                            xhr.setRequestHeader('X-CSRF-Token', csrf.val());
                            setLoading();
        ...
        if ($('#form-barang-detail').valid()) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "<?= base_url("bea-cukai-bc-27/id/barang"); ?>",
                        data: formData,
                        beforeSend: function(xhr) {
                            xhr.setRequestHeader('X-CSRF-Token', csrf.val());
                            $('#btn-loading').show();
    ...
    function removePungutan(kodeJenisPungutan) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                const csrf = $(`[name="${csrfToken}"]`);
                $.ajax({
                    url: "<?= base_url("bea-cukai-bc-27/id/barang/pungutan-delete"); ?>",
                    data: {
                        id: "<?= encrypt($bc27['id']) ?>",
    ...
    function removeBahanBaku(indexDelete) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                const csrf = $(`[name="${csrfToken}"]`);
                $.ajax({
                    url: "<?= base_url("bea-cukai-bc-27/id/barang/bahan-baku-delete"); ?>",
                    data: {
                        id: "<?= encrypt($bc27['id']) ?>",
