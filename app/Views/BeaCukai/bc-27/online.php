...
<section class="section">
    <div class="section-header">
        <h1>Status Respon Dokumen BC 2.7</h1>
        <a href="<?= base_url('bea-cukai-bc-27') ?>" type="button" class="btn btn-show-form btn-add float-right">
...
<script>
    $(document).ready(function() {
        ...
        function getList() {
            $.ajax({
                url: `<?= base_url('bea-cukai-bc-27/all-online'); ?>`,
                method: "GET",
                beforeSend: function() {
                    setLoading();
                },
