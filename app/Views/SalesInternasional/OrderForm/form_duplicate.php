...
<section class="section">
    <div class="section-header">
        <h1 class="title-name">Duplicate Order Form</h1>
        ...
        <div class="card-body">
            <form class="create-form form-add-spp" role="form" method="POST" enctype="multipart/form-data" id="form-parent">
                    ...
                    <div class="col-md-6">
                        <div class="form-floating mb-3" style="height: 50px;">
                            <div class="input-group input-group-password">
                                <div class="form-floating mb-3" style="height: 50px;">
                                    <input autocomplete="one-time-code" type="text" value="<?= 'AUTO GENERATE' ?>" readonly class="form-control sales_order_export_no" id="sales_order_export_no" name="sales_order_export_no" placeholder="Sales Order No" required>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-floating mb-3" style="height: 50px;">
                            <div class="input-group input-group-password">
                                <div class="form-floating mb-3" style="height: 50px;">
                                    <input autocomplete="one-time-code" class="form-control input-picker actualy_shipment_date" id="actualy_shipment_date" name="actualy_shipment_date" placeholder="Actually Shipment Date" value="">
                    ...
                    <div class="col-md-4">
                        <div class="form-floating mb-3">
                            <input autocomplete="one-time-code" value="<?= !empty($dataSalesExport) ? $dataSalesExport->tax_id : '' ?>" type="text" class="form-control tax_id" id="tax_id" name="tax_id" placeholder="Tax Id (Optional)">
                            <label for="floatingInput">Tax ID (Optional)</label>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-floating mb-3">
                            <input autocomplete="one-time-code" type="text" class="form-control deadline" id="deadline" name="deadline" placeholder="Deadline" value="">
                            <label for="floatingInput">Deadline</label>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-floating mb-3">
                            <input autocomplete="one-time-code" type="text" class="form-control container" id="container" name="container" placeholder="No. Container (Optional)" value="">
                    ...
                    <div class="col-md-4">
                        <div class="form-floating mb-3">
                            <input autocomplete="one-time-code" type="text" class="form-control destination" id="destination" name="destination" placeholder="Destination" value="">
                    ...
                    <div class="col-md-4">
                        <div class="form-floating mb-3">
                            <input autocomplete="one-time-code" type="text" class="form-control po_no" id="po_no" name="po_no" placeholder="PO No (Opsional)" value="">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-4">
                        <div class="form-floating mb-3">
                            <input autocomplete="one-time-code" type="text" class="form-control freight" id="freight" name="freight" placeholder="Freight (Optional)" value="<?= !empty($dataSalesExport) ? $dataSalesExport->freight : '' ?>">
                            <label for="floatingInput">Freight (Optional)</label>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-floating mb-3">
                            <input autocomplete="one-time-code" type="text" class="form-control additional" id="additional" name="additional" placeholder="Additional (Optional)" value="<?= !empty($dataSalesExport) ? $dataSalesExport->additional : '' ?>">
                            <label for="floatingInput">Additional 1 (Optional)</label>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-floating mb-3">
                            <input autocomplete="one-time-code" type="text" class="form-control additional_2" id="additional_2" name="additional_2" placeholder="Additional 2 (Optional)" value="<?= !empty($dataSalesExport) ? $dataSalesExport->additional_2 : '' ?>">
