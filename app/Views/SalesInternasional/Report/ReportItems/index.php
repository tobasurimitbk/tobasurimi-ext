                ...
                <div class="col-md-3">
                    <div class="input-group">
                        <div class="form-floating" style="height: 50px;">
                            ...
                            <label style="z-index: 1;" style="z-index: 1;">Start Actual Date</label>
                        </div>
                ...
                <div class="col-md-3">
                    <div class="input-group">
                        <div class="form-floating" style="height: 50px;">
                            ...
                            <label style="z-index: 1;" style="z-index: 1;">End Actual Date</label>
                        </div>
                        <div class="input-group-append" style="height:50px;">
                            <button disabled class="btn btn-secondary" type="button">
                                <i class="fas fa-calendar-alt"></i>
                    ...
                    <table class="table table-bordered nowrap table-hover-tobasurimi dataTable" id="dataTable" width="100%" cellspacing="0">
                        <thead class="thead-dark">
                            <tr style="text-align: center;">
                                ...
                                <th style="text-align:left;" onclick="changeSort('sales_order_export.actualy_shipment_date')">Actual Date</th>
