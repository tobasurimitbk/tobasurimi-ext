...
<body>
    ...
    <table class="mt-1 item-table border-collapse">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td></td>
                <td><label class="label-header"><?= number_format($salesKontrak['potongan_harga']); ?></label></td>
            </tr>
            <tr>
    ...
    <div class="header">
        ...
        <div class="mt-1 txt-left"><label class="label-header">ESTIMATED SHIPMENT DATE: <?= date('d M Y', strtotime($salesKontrak['shipment_date'])); ?></label></div>
