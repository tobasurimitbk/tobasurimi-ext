...
<body>
    ...
    <table class="mt-5">
        <tr>
            <td width="550">Tanggal Dibuat : <?= $stuffingLokal['tanggal']; ?></td>
            <td>No. Stuffing Lokal : <?= $stuffingLokal['no_stuffing']; ?></td>

        </tr>
        <tr>
            <td>Sales Order: <?= $stuffingLokal['no_sales_order']; ?></td>
            <td>Customer: <?= $stuffingLokal['customer_name']; ?></td>
            <td></td>
        </tr>
        <tr>
            <td></td>
    ...
    <table class="mt-5 table-border">
        ...
        <tbody>
            ...
            foreach ($stuffingLokalDetail as $row) {
            ?>
                <tr>
                    <td class="table-border"><?= $no ?></td>
