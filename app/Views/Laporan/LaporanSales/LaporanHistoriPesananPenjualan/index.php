...
<section class="section">
    <div class="section-header">
        <h1>Laporan Histori Pesanan Penjualan</h1>
        ...
        <ul class="dropdown-menu list-dropdown-company" aria-labelledby="dropdownMenuButtonExport">
            <li>
                <button class="dropdown-item" onclick="printPDF('<?= base_url("/laporan-sales/histori-pesanan-penjualan/printPDFAll"); ?>')">PDF</button>
            </li>
            <li>
                <button class="dropdown-item" onclick="printExcel('<?= base_url("/laporan-sales/histori-pesanan-penjualan/printExcelAll"); ?>')">EXCEL</button>
            </li>
        </ul>
    </div>
    <div class="card">
...
<script>
    ...
    $(document).ready(function() {
        ...
        const table = $('.dataTable').DataTable({
            ...
            pageLength: 25,
            ajax: {
                url: "<?= base_url("laporan-sales/histori-pesanan-penjualan/all"); ?>",
                dataSrc: "data",
                data: function(data) {
