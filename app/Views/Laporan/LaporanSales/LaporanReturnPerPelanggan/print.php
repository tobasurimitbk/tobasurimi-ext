...
<head>
    <meta charset="utf-8">
    <title>Laporan Return Penjualan Per Pelanggan</title>
    <style>
        body {
...
<body>
    ...
    <h2 style="text-align: center;">LAPORAN RETURN PENJUALAN PER PELANGGAN</h2>
            ...
            <?php foreach ($data as $item): ?>
                <?php if (isset($item['is_customer']) && $item['is_customer']): ?>
                    <tr class="customer-row">
                        <td colspan="7" class="text-left"><?= $item['no_return'] ?></td>
                    </tr>
