...
<section class="section">
    <div class="section-header">
        <h1>Laporan Return Penjualan Per Pelanggan</h1>
        ...
        <ul class="dropdown-menu list-dropdown-company" aria-labelledby="dropdownMenuButtonExport">
            <li>
                <button class="dropdown-item" onclick="printPDF('<?= base_url("/laporan-sales/return-sales-per-pelanggan/printPDF"); ?>')">PDF</button>
            </li>
            <li>
                <button class="dropdown-item" onclick="printExcel('<?= base_url("/laporan-sales/return-sales-per-pelanggan/printExcel"); ?>')">EXCEL</button>
            </li>
        </ul>
    </div>
    <div class="card">
...
<script>
    ...
    $(document).ready(function() {
        ...
        const table = $('.dataTable').DataTable({
            ...
            pageLength: 25,
            ajax: {
                url: "<?= base_url("laporan-sales/return-sales-per-pelanggan/all"); ?>",
                dataSrc: "data",
                data: function(data) {
