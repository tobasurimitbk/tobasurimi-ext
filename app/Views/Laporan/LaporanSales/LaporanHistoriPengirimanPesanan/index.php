...
<section class="section">
    <div class="section-header">
        <h1>Laporan Histori Pengiriman Pesanan</h1>
        ...
        <ul class="dropdown-menu list-dropdown-company" aria-labelledby="dropdownMenuButtonExport">
            <li>
                <button class="dropdown-item" onclick="printPDF('<?= base_url("/laporan-sales/histori-pengiriman-pesanan/printPDFAll"); ?>')">PDF</button>
            </li>
            <li>
                <button class="dropdown-item" onclick="printExcel('<?= base_url("/laporan-sales/histori-pengiriman-pesanan/printExcelAll"); ?>')">EXCEL</button>
            </li>
        </ul>
    </div>
    <div class="card">
...
<script>
    ...
    $(document).ready(function() {
        ...
        const table = $('.dataTable').DataTable({
            ...
            pageLength: 25,
            ajax: {
                url: "<?= base_url("laporan-sales/histori-pengiriman-pesanan/all"); ?>",
                dataSrc: "data",
                data: function(data) {
            ...
            createdRow: function(row, data, dataIndex) {
                if (data.is_customer) {
                    ...
                    $(row).html(`
                        <td colspan="3" class="text-left txt-bold" style="font-weight:700!important">Total</td>
                        <td class="text-center txt-bold" style="font-weight:700!important">${data.qty_faktur}</td>
                        <td colspan="3" class="text-left txt-bold" style="font-weight:700!important"></td>
                        <td class="text-center txt-bold" style="font-weight:700!important">${data.qty_order}</td>
                        <td colspan="2"></td>
                    `);
                }
            },
