...
<section class="section">
    <div class="section-header">
        <h1>Pendapatan Supplier Per PO (Pembelian)</h1>
        ...
        <ul class="dropdown-menu list-dropdown-company" aria-labelledby="dropdownMenuButtonExport">
            <li><button class="dropdown-item pdf" onclick="pdf('<?= base_url("/laporan-supplier-lokal-bb/pendapatan-supplier-pembelian/print"); ?>')">PDF</button></li>
            <li><button class="dropdown-item excel" onclick="excel('<?= base_url("/laporan-supplier-lokal-bb/pendapatan-supplier-pembelian/export-excel"); ?>')">Excel</button></li>
        </ul>
