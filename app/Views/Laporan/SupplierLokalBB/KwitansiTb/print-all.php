...
<head>
    ...
    @page {
        ...
        .page {
            page-break-after: always; /* memaksa halaman baru saat cetak */
        }
     ...
     "company"
                ...
                <table class="w-100 mt-2">
                    <tr>
                        ...
                        <td style="vertical-align: top; width: 55%;"><?= $d[
                            "company"
                        ]["holding_company"] ?> (<?= strtoupper(
     $d["company"]["company"]
 ) ?>)</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="vertical-align: top;">: </td>
                        <td style="vertical-align: top;">PEMBELIAN <?= $d[
                            "kwintansi"
                        ]["nama_barang"] ?> SEBANYAK <?= number_format(
     $d["kwintansi"]["qty"],
     2
                ...
                <div class="w-100" style="margin-top: -20px;text-align:center;">
                    <div style="text-align: right;">
                        ...
                        <div class="mt-2">(<?= $d["kwintansi"]["supplier"][
                            "name"
                        ] ?>)</div>
                    </div>
                </div>
