...
<section class="section">
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 col-12">
            <a href="<?= base_url('laporan-supplier-lokal-bb/pendapatan-supplier-pembelian') ?>">
                <div class="card card-statistic-1">
                    <div class="card-icon bg-danger">
                        <i class="far fa-file"></i>
                    </div>
                    <div class="card-wrap">
                        <div class="card-header">
                            <h4>Pendapatan Supplier Per PO (Pembelian)</h4>
                        </div>
                    </div>
                </div>
            </a>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 col-12">
            <a href="<?= base_url('laporan-supplier-lokal-bb/rekap-all-supplier-pembelian') ?>">
                <div class="card card-statistic-1">
                    <div class="card-icon bg-danger">
                        <i class="far fa-file"></i>
                    </div>
                    <div class="card-wrap">
                        <div class="card-header">
                            <h4>Rekap All Supplier (Pembelian)</h4>
                        </div>
                    </div>
                </div>
            </a>
