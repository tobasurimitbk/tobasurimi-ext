    ...
    <div class="section-header">
        ...
        <?php if (can('Laporan', 'Accounting', 'p')) : ?>
            ...
            <ul class="dropdown-menu list-dropdown-company" aria-labelledby="dropdownMenuButtonExport">
                <li><button class="dropdown-item" onclick="printPDF('<?= base_url("/laporan-jasa-vendor/printPDF"); ?>')">PDF</button></li>
                <li><button class="dropdown-item" onclick="printExcel('<?= base_url("/laporan-jasa-vendor/printExcel"); ?>')">EXCEL</button></li>
            </ul>
        <?php endif; ?>
                            ...
                            <table class="table table-bordered nowrap table-hover-tobasurimi dataTable" id="dataTable" width="100%" cellspacing="0">
                                <thead class="thead-dark">
                                    <tr>
                                        ...
                                        <th>Qty Terima</th>
                                        <th>Hasil Rebus</th>
                                        <th>Presentase Hasil Rebus (Qty Terima)</th>
                                        <th>Hasil Daging</th>
                                        <th>Presentase Hasil Daging (Qty Terima)</th>
                                    </tr>
                                </thead>
...
<script>
    ...
    $(document).ready(function() {
        ...
        const table = $('.dataTable').DataTable({
            ...
            pageLength: 25,
            ajax: {
                url: "<?= base_url("laporan-accounting/jasa-vendor/all"); ?>",
                dataSrc: "data",
                data: function(data) {
                    data.search = $(".search").val();
                    data.list_barang = $(".list_barang").val();
