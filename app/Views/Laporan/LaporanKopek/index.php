...
<section class="section">
    <div class="section-header">
        <div class="col-md-10">
            <h1>Rekap Laporan Harian Kopek</h1>
        </div>
        ...
        <div class="col-md-2 text-right">
            <div class="btn-group">
                ...
                <div class="dropdown-menu" role="menu">
                    <a class="dropdown-item" onclick="printPDF('<?= base_url("/laporan-accounting/rekap-kopek/printPDF"); ?>')">PDF</a>
                    <a class="dropdown-item" onclick="printExcel('<?= base_url("/laporan-accounting/rekap-kopek/printExcel"); ?>')">Excel</a>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        const table = $('.dataTable').DataTable({
            ...
            pageLength: 25,
            ajax: {
                url: "<?= base_url("laporan-accounting/rekap-kopek/all"); ?>",
                dataSrc: "data",
                data: function(data) {
