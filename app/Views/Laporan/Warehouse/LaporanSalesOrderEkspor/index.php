...
<section class="section">
    <div class="section-header">
        <h1>Laporan Sales Order Ekspor</h1>
        ...
        <ul class="dropdown-menu list-dropdown-company" aria-labelledby="dropdownMenuButtonExport">
            <li><button class="dropdown-item pdf" onclick="pdf('<?= base_url("/laporan-warehouse/sales-order-ekspor/print"); ?>')">PDF</button></li>
        </ul>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered nowrap table-hover-tobasurimi dataTable" id="dataTable" width="100%" cellspacing="0">
                        <thead class="thead-dark">
                            <tr>
                                <th>No</th>
                                <th onclick="changeSort('sales_order_export_no')" class="sort">Nomor</th>
                                <th onclick="changeSort('tanggal')" class="sort">Tanggal</th>
                                <th onclick="changeSort('nama_pelanggan')" class="sort">Buyer</th>
...
<script>
    ...
    var table = $('.dataTable').DataTable({
        ...
        pageLength: 25,
        ajax: {
            url: "<?= base_url("/laporan-warehouse/sales-order-ekspor/all-sales-order-ekspor"); ?>",
            dataSrc: "data",
            data: function(data) {
    ...
    const pdf = function(url) {
        ...
        window.open(url + `?dateStart=${dateStart}&dateEnd=${dateEnd}&sort=${sort}&sortType=${sortType}`, "_blank");
    }
</script>
