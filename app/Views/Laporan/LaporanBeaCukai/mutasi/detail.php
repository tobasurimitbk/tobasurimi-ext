    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-floating mb-3" style="height: 50px;">
                        <input disabled autocomplete="one-time-code" value="<?= number_format($mutasi['akhir'], 2) . " " . $mutasi['kode_satuan'] ?>" type="text" class="form-control" placeholder="">
...
<script>
    var tableMasuk = $('#dataTableMasuk').DataTable({
        ...
        pageLength: 25,
        ajax: {
            url: "<?= base_url('laporan-bea-cukai/mutasi/all-masuk') ?>",
            type: "GET",
            data: function(d) {
    ...
    var tableMasukProduksi = $('#dataTableMasukProduksi').DataTable({
        ...
        pageLength: 25,
        ajax: {
            url: "<?= base_url('laporan-bea-cukai/mutasi/all-masuk-produksi') ?>",
            type: "GET",
            data: function(d) {
    ...
    var tableKeluarProduksi = $('#dataTableKeluarProduksi').DataTable({
        ...
        pageLength: 25,
        ajax: {
            url: "<?= base_url('laporan-bea-cukai/mutasi/all-keluar-produksi') ?>",
            type: "GET",
            data: function(d) {
    ...
    var tableKeluar = $('#dataTableKeluar').DataTable({
        ...
        pageLength: 25,
        ajax: {
            url: "<?= base_url('laporan-bea-cukai/mutasi/all-keluar') ?>",
            type: "GET",
            data: function(d) {
