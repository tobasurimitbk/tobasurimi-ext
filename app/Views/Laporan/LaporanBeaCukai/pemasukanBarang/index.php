...
<section class="section">
    <div class="section-header">
        ...
        <ul class="dropdown-menu list-dropdown-company" aria-labelledby="dropdownMenuButtonExport">
            <li><button class="dropdown-item pdf" onclick="pdfExcel('<?= base_url("/laporan-bea-cukai/laporan-pemasukan-barang/print"); ?>')">PDF</button></li>
            <li><button class="dropdown-item pdf" onclick="pdfExcel('<?= base_url("/laporan-bea-cukai/laporan-pemasukan-barang/excel"); ?>')">Excel</button></li>
        </ul>
        ...
        <div class="card-body">
            ...
            <div class="row ">
                ...
                <div class="col-md-2">
                    <div class="input-group">
                        <div class="form-floating" style="height: 50px;">
                            <input value="<?= date('d/m/Y') ?>" placeholder="" class="form-control dateEnd" id="dateEnd" name="dateEnd" aria-label="Floating label select example" />
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                $.each(res.data.data, function(i, v) {
                    ...
                    newRow.append($('<td>').text(v.noPenerimaan));
                    newRow.append($('<td>').text(v.tglPenerimaan));
                    ...
                    newRow.append($('<td>').text(v.pengirim));
