...
<script>
    ...
    $(document).ready(function() {
        ...
        $('.list_supplier, .dokumen, .tipe_penjualan, .divisi_id')
            .parent('div')
            .children('span')
            .children('span')
            .children('span')
        ...
        $(".dateStart, .dateEnd, .list_supplier, .tipe_penjualan, .divisi_id").change(function() {
            table.ajax.reload();
        })
    ...
    const printPDF = function(url) {
        ...
        var filter = $(".tipe_penjualan option:selected").val() ? $(".tipe_penjualan option:selected").val() : "all";
        var filter_divisi = $(".divisi_id option:selected").val() ? $(".divisi_id option:selected").val() : "all";
        url2 = url + "/" + tanggal_awal + "/" + tanggal_akhir + "/" + filter + "/" + search + "/" + filter_divisi;
        // console.log(url2);
