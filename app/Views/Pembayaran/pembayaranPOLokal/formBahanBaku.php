                                                ...
                                                <?php if (!empty($detail)) : ?>
                                                    ...
                                                    <?php foreach ($detail['itemList']['detail'] as $d) : ?>
                                                        <tr>
                                                            ...
                                                            <td><?= number_format($d['total_tagihan'],2) ?></td>
                                                            <td><?= number_format($d['sisa_pembayaran'],2 )?></td>
                                                            <td><input autocomplete="one-time-code" oninput="limitInputBayar(this,<?= $d['total_tagihan']; ?>)" class="form-control pembayaran" type="text" value="<?= $d['total']; ?>" name = "pembayaran" style="height:40px"></td>
                                                        </tr>
                                                    <?php endforeach; ?>
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center;">
                                                            <b><?= $detail['itemList']['total_order'] ?></b>
                                                        </td>
                                                        <td style="text-align: center;">
                                                            <b><?= $detail['itemList']['total_order'] ?></b>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="text-align: left;">
                                                        <?= number_format( $detail['itemList']['total_bayar_panjar'],2) ; ?>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <<td colspan="6" style="text-align: right;">
                                                        ...
                                                        <td style="text-align: left;">
                                                            <?= number_format( $detail['itemList']['total_akhir'],2) ; ?>
                                                        </td>
                                                    </tr>
                                                <?php else : ?>
                                                    <tr>
                                                        <td colspan="6" style="text-align: right;">
                                                            <b>TOTAL PEMBAYARAN PANJAR</b>
                                                        </td>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered nowrap table-hover-tobasurimi dataTable" id="dataTable-panjar" width="100%" cellspacing="0">
                                        ...
                                        <tbody class="body-table" id="body-table-panjar" style="cursor: pointer;">
                                                ...
                                                <?php if(!empty($panjar)) : ?>
                                                    <?php $no = 1 ; foreach($panjar as $p):   ?>
                                                        <tr style="color:whitesmoke">
                                                            <td> <?=  $no++ ?> </td> 
                                                            <td class="no-panjar"> <?=  $p['no_panjar'] ;?>    </td> 
                                                            <td class="panjar-date"> <?=  $p['payment_date'] ;?></td> 
                                                            <td class="total-panjar"> <?=  $p['total_panjar'] ;?></td>
                                                            <td class="sisa_panjar"><?=  $p['sisa_panjar'] ;?></td>
                                                            <td class="bayar-panjar"> <?=  $p['bayar_panjar'] ;?></td>
                                                ...
                                                <?php else: ?>
                                                    ...
                                                    <tr style="color:white">
                                                        <td colspan="6" style="text-align: center;">Tidak ada pembayaran panjar</td>
                                                    </tr>
    ...
    function appendPanjarNo(data){
        ...
        tablePanjar.find('tfoot').empty();
            ...
            if(data.length > 0){
                ...
                if(!found){
                    var newRow = $('<tr>');
                    newRow.append($('<td colspan="" style="text-align:center">Tidak Ada Panjar</td>'));
                    tablePanjar.find('tbody').append(newRow);
                }
            }else{
                var newRow = $('<tr>');
