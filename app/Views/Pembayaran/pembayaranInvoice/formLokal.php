        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                $.each(res.data, function(index, item) {
                    ...
                    newRow.append($('<td style="text-align:center;">').text(formatRupiah(item.harga_barang_invoice)));
                    newRow.append($('<td style="text-align:center;">').text(formatRupiah(item.amount_invoice)));
