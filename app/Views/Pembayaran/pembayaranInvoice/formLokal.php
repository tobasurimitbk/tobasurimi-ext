        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                newRow3.append($('<td style="text-align:center;"><b>' +
                    `<input autocomplete="one-time-code" data-id="" onchange="this.value = formatRupiah2(this.value)" class="form-control potongan trigger-input" type="text" value="<?= !empty($detail) ? formatRupiah2($detail['potongan'])  : '' ?>" name="potongan" oninput="limitInputBayar(this, ${limit_bayar})">` +
                    '</b></td>'));
                ...
                newRow4.append($('<td style="text-align:center;"><b>' +
                    `<input autocomplete="one-time-code" data-id="" onchange="this.value = formatRupiah2(this.value)" class="form-control total-bayar trigger-input" type="text" value="<?= !empty($detail) ? formatRupiah2($detail['total_bayar'])  : '' ?>" name = "total_bayar"> ` +
                    '</b></td>'));
