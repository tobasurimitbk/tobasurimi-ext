...
<section class="section">
    <div class="section-header">
        <h1>Bahan Setengah Jadi</h1>
        <?php if (can('Master Barang', 'Bahan Setengah Jadi', 'c')) : ?>
...
<div class="modal" id="import_excel_modal" tabindex="-1">
    <div class="modal-dialog" style="min-width: 900px">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Import Master Bahan Setengah Jadi</h5>
            </div>
            <div class="modal-body">
...
<script>
    ...
    const table = $('.dataTable-barang').DataTable({
        ...
        columns: [{
            ...
            },
            {
                ...
                render: function(data, type, row) {
                    ...
                    return `
                        <?php if (can('Master Barang', 'Bahan Setengah Jadi', 'u')) : ?>
                            <a href="javascript:void(0)" onclick="edit('${id}')" data-toggle="tooltip" title="Edit" class="btn btn-primary">
                                <i class="fas fa-edit"></i>
                            </a>
                        <?php endif; ?>
                         <?php if (can('Master Barang', 'Bahan Setengah Jadi', 'd')) : ?>
        ...
        language: {
            emptyTable: "Master Data Bahan Setengah Jadi Masih Kosong",
    ...
    $(document).ready(function() {
        ...
        $('.btn-add-barang').click(function() {
            $('.title-name').text("Tambah Bahan Setengah Jadi");
        ...
        //             $('.delete-btn').show();
        //             $('.title-name').text("Update Bahan Setengah Jadi");
        //             <?php if (!can('Master Barang', 'Bahan Setengah Jadi', 'u')) : ?>
        ...
        if ($('.form-excel').valid()) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    formData.append('type_barang', "bahan_setengah_jadi");
                    $.ajax({
