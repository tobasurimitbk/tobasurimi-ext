...
<section class="section">
    <div class="section-header">
        <h1>Barang Jadi</h1>
        <?php if (can('Master Barang', 'Barang Jadi', 'c')) : ?>
...
<div class="modal" id="import_excel_modal" tabindex="-1">
    <div class="modal-dialog" style="min-width: 900px">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Import Master Barang Barang Jadi</h5>
            </div>
            <div class="modal-body">
                <div class="alert alert-secondary text-black" role="alert">
                    UNDUH FORMAT EXCEL <a href="<?= base_url('assets/import/IMPORT_EXCEL_MASTER_BJ.xlsx') ?>" style="text-decoration: none;"><b style="color: black;">DISINI</b></a>
                </div>
...
<script>
    ...
    const table = $('.dataTable-barang').DataTable({
            ...
            },
            {
                ...
                render: function(data, type, row) {
                    ...
                    return `
                        ...
                        <?php endif; ?>
                         <?php if (can('Master Barang', 'Barang Jadi', 'd')) : ?>
        ...
        language: {
            emptyTable: "Master Data Barang Jadi Masih Kosong",
        ...
        if ($('.form-excel').valid()) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    formData.append('type_barang', "bahan_jadi");
                    $.ajax({
