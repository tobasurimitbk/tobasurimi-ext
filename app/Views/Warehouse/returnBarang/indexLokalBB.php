...
<section class="section">
    <div class="section-header">
        <h1>Retur Purchase Lokal Bahan Baku</h1>
        <?php if (can("Retur Pembelian", "Retur Lokal BB", "c")) : ?>
            <a href="<?= base_url('retur-po-lokal-bb/create') ?>" type="button" class="btn btn-show-form btn-add float-right">
...
<script>
    ...
    const table = $('.dataTable').DataTable({
        ...
        pageLength: 25,
        ajax: {
            url: "<?= base_url("retur-po-lokal-bb/all"); ?>",
            dataSrc: "data",
            data: function(data) {
            ...
            },
            {
                ...
                render: function(data, type, row) {
                    ...
                    if (status_post === "WAITING") {
                        ...
                        <div class="mt-0">
                            <?php if (can('Retur Pembelian', 'Retur Lokal BB', 'u')): ?>
                                <a href="<?= base_url("retur-po-lokal-bb/id"); ?>/${id}" data-toggle="tooltip" title="Edit" class="btn btn-primary">
                                    <i class="fas fa-edit"></i>
                                </a>
                            <?php endif ?>
                            <?php if (can('Retur Pembelian', 'Retur Lokal BB', 'p')) : ?>
                                <button data-toggle="tooltip" title="Print" class="btn btn-warning btn-print" onclick="print('<?= base_url("retur-po-lokal-bb/print/"); ?>${id}')" style="box-shadow: none !important;">
                    ...
                    `
                        ...
                        if (status_bc === 0) {
                            string += `
                            <?php if (can('Retur Pembelian', 'Retur Lokal BB', 'ua')) : ?>
