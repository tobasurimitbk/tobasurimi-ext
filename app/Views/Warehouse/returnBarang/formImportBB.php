...
<section class="section">
    <div class="section-header">
        <h1 class="title-name">Retur Purchase Import Barang Bahan Baku</h1>
...
<script>
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            if (id) {
                                // UPDATE
                                $.ajax({
                                    url: "<?= base_url("retur-po-import-bb/update"); ?>",
                                    data: data,
                                ...
                                // INSERT
                                $.ajax({
                                    url: "<?= base_url("retur-po-import-bb/save"); ?>",
                                    data: data,
                                    beforeSend: function(xhr) {
                                        xhr.setRequestHeader('X-CSRF-Token', csrf.val());
                                        setLoading();
    ...
    function generateNumber() {
        ...
        if (value) {
            ...
            $.ajax({
                url: `<?= base_url("retur-po-import-bb/generate-number"); ?>`,
                method: "GET",
                data: {
                    divisi_id: $('#divisi_id option:selected').val()
                },
