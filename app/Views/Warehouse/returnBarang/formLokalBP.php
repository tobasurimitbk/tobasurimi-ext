...
<script>
    ...
    $('.multiple_po_id').select2({
        ...
        $.ajax({
            url: `<?= base_url("penerimaan-barang-lokal-bp/return-barang/list-barang"); ?>`,
            method: "GET",
            data: {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        if (pengembalian_barang_id) {
                            ...
                            $.ajax({
                                url: "<?= base_url("penerimaan-barang-lokal-bp/return-barang/update"); ?>",
                                data: formData,
                                method: "POST",
                                dataType: "json",
                                processData: false,
                            ...
                            $.ajax({
                                url: "<?= base_url("penerimaan-barang-lokal-bp/return-barang/insert"); ?>",
                                data: formData,
                                method: "POST",
                                dataType: "json",
                                processData: false,
    ...
    function changeStatus() {
        ...
        if (value) {
            ...
            $.ajax({
                url: `<?= base_url("penerimaan-barang-lokal-bp/return-barang/generate-po-no"); ?>`,
                method: "GET",
                data: {
