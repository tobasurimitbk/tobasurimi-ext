...
<section class="section">
    <div class="section-header">
        <h1>Retur Purchase Import Bahan Penolong</h1>
        <?php if (can("Retur Pembelian", 'Retur Import BP', "c")) : ?>
            <a href="<?= base_url('retur-po-import-bp/create') ?>" type="button" class="btn btn-show-form btn-add float-right">
...
<script>
    ...
    const table = $('.dataTable').DataTable({
        ...
        pageLength: 25,
        ajax: {
            url: "<?= base_url("retur-po-import-bp/all"); ?>",
            dataSrc: "data",
            data: function(data) {
            ...
            },
            {
                ...
                render: function(data, type, row) {
                    ...
                    `
                        ...
                        if (status_bc === 0) {
                            string += `
                            <?php if (can('Retur Pembelian', 'Retur Import BP', 'ua')) : ?>
