                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-floating mb-3">
                            <textarea
                                <?= !empty($mutasi) ? ($mutasi['status_posting'] ? 'disabled' : '') : '' ?>
                                class="form-control keterangan"
                                placeholder="Keterangan"
                                id="keterangan"
                                name="keterangan"
                                style="height: 180px;"><?= !empty($mutasi) ? $mutasi['keterangan'] : '' ?></textarea>
                ...
                <div class="detail-form-component">
                    <div class="detail-form-layout">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-4 form-fifo">
                                <div class="form-floating" style="height: 50px;">
                                    <input placeholder="Keterangan" class="form-control keterangan_fifo" id="keterangan_fifo" name="keterangan_fifo" />
