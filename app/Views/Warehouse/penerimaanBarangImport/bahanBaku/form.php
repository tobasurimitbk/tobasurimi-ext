...
<section class="section">
    <div class="section-header">
        <h1 class="title-name">Tambah Penerimaan Barang Import Bahan Baku</h1>
        <div class="col-button-tambah-spp">
            ...
            <?php if (!empty($dataPenerimaanBarang)) : ?>
                <button class="btn btn-warning btn-print float-right" onclick="print('<?= base_url("penerimaan-barang-import-bb/print/"); ?><?= $dataPenerimaanBarang['id']; ?>')">
                    Print
                </button>
            <?php endif; ?>
            <?php if (!empty($dataPenerimaanBarang)) : ?>
                                ...
                                success: function(response) {
                                    ...
                                    if (response.status) {
                                        Swal.fire({
                                            ...
                                            window.location.href = "<?= base_url("penerimaan-barang-import-bb"); ?>" + '/id/' + response.id;
                                        });
                                    }
                                }
                            });
