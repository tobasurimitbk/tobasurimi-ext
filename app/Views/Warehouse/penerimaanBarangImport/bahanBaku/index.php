...
<section class="section">
    <div class="section-header">
        <h1>Penerimaan Barang Import Baku</h1>
        <?php if (can('Warehouse', 'P. Barang Import BB', 'p')) : ?>
            ...
            <ul class="dropdown-menu list-dropdown-company" aria-labelledby="dropdownMenuButtonExport">
                <li><button class="dropdown-item" onclick="pdf('<?= base_url("penerimaan-barang-import-bb/print-table"); ?>')">PDF</button></li>
                <li><button class="dropdown-item" onclick="pdf('<?= base_url("penerimaan-barang-import-bb/export-excel"); ?>')">EXCEL</button></li>
            </ul>
        <?php endif; ?>
        <?php if (can('Warehouse', 'P. Barang Import BB', 'c')) : ?>
            <a class="btn btn-show-form btn-add float-right" href="<?= base_url("penerimaan-barang-import-bb/create"); ?>">
                    ...
                    <table class="table table-bordered nowrap table-hover-tobasurimi dataTable" id="dataTable" width="100%" cellspacing="0">
                        <thead class="thead-dark">
                            <tr>
                                ...
                                <th onclick="changeSort('metadata.value')">Dokumen</th>
                                <th>Jml Item</th>
                                <th>COA</th>
                                <th>Action</th>
                            </tr>
...
<script>
    ...
    const table = $('.dataTable').DataTable({
        ...
        pageLength: 25,
        ajax: {
            url: "<?= base_url("penerimaan-barang-import-bb/all"); ?>",
            dataSrc: "data",
            data: function(data) {
                    ...
                    if (status == "WAITING") {
                        ...
                        <div class="mt-0">
                          <?php if (can('Warehouse', 'P. Barang Import BB', 'u')): ?>
                                <a href="<?= base_url("penerimaan-barang-import-bb/id"); ?>/${id}" data-toggle="tooltip" title="Edit" class="btn btn-primary">
