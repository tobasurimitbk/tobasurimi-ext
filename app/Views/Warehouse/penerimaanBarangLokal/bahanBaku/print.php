    ...
    <?php if (!empty($dataPenerimaanBarang)) : ?>
        ...
        <table class="w-100 mt-050">
            ...
            <tr>
                ...
                <td class="txt-right">
                    <div><span class="txt-bold">Bahan Baku: <?= $dataPenerimaanBarang->barang_name; ?></span></div>
                </td>
            </tr>
        </table>
        <table class="item-table mt-050">
            ...
            <?php foreach ($dataPenerimaanBarangDetail as $detail) : ?>
                ...
                <tr>
                    ...
                    <td class="txt-right" style="text-align:center;"><?= number_format($dataPenerimaanBarang->total_before_pph, 2, '.', ','); ?></td>
            ...
            <tr>
                ...
                <td class="txt-right" style="text-align:center;"><?= number_format($dataPenerimaanBarang->total_before_pph - $dataPenerimaanBarang->total_after_pph, 2, '.', ','); ?></td>
                <td></td>
            </tr>
            <tr>
                <td class="txt-left" style="padding-left: 5px" colspan="4"><b>TOTAL DIBAYARKAN</b></td>
                <td class="txt-right" style="text-align:center;"><?= number_format($dataPenerimaanBarang->total_after_pph, 2, '.', ','); ?></td>
                <td></td>
            </tr>
        </table>
