                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-floating mb-3" style="height: 50px;">
                                <input autocomplete="one-time-code" type="text" class="form-control jabatan_name" id="jabatan_name" name="jabatan_name" placeholder="Nama Jabatan" maxlength="30">
...
<section class="section">
    <div class="section-header">
        <h1>Jabatan</h1>
        <?php if (can('Personalia', 'Jabatan', 'c')): ?>
