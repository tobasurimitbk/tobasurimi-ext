    ...
    <div class="card">
        <div class="card-body">
            <div class="row justify-content-end row-col-spp">
                ...
                <div class="col mb-3">
                    <input class="form-control search form-out-search" placeholder="Ketik No Permintaan" value="" />
                </div>
            </div>
            <div class="row">
                <div class="table-responsive">
                    <table class="table nowrap table-hover-tobasurimi dataTable" id="dataTable" width="100%" cellspacing="0">
                        <thead class="thead-dark">
                            <tr>
                                <th>No.</th>
                                <th onclick="changeSort('sppType')" class="sort">Tipe Permintaan</th>
                                <th onclick="changeSort('sppNo')" class="sort">No. Permintaan</th>
