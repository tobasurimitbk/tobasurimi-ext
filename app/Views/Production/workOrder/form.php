    ...
    <div class="card-body">
        <form class="create-form form-add-spp" role="form" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-floating mb-3" style="height: 50px;">
                        <input autocomplete="one-time-code" type="text" value="<?= !empty($dataWorkOrders) ? formatter($dataWorkOrders->production_amt, "STR_TO_INT") : ""; ?>"  oninput="this.value=this.value.replace(/[^0-9]/g,'');" class="form-control production_amt" name="production_amt" id="production_amt" placeholder="Hasil">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-floating mb-3" style="height: 50px;">
                        <input autocomplete="one-time-code" type="text" value="<?= !empty($dataWorkOrders) ? formatter($dataWorkOrders->target, "STR_TO_INT") : ""; ?>"  oninput="this.value=this.value.replace(/[^0-9]/g,'');" class="form-control target" name="target" id="target" placeholder="Target">
