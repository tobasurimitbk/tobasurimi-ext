...
<section class="section">
    <div class="section-header">
        <h1>Rekap Pembuatan Dokumen BC 4.0</h1>
...
<script>
    ...
    function drawTable() {
        $.ajax({
            url: '<?= base_url('/dashboard/list-dokumen-bc40/all') ?>',
            method: "GET",
            data: {
                date: $('#date').val()
            },
            ...
            success: function(res) {
                ...
                if (res.length > 0) {
                    $.each(res, function(i, v) {
                        ...
                        newRow.append($('<td style="text-align:center;">').text(v.po_type));
                        ...
                        newRow.append($('<td style="text-align:center;">').text(v.no_bukti));
    ...
    function exportSheet(event) {
        ...
        $.ajax({
            url: '<?= base_url('/dashboard/list-dokumen-bc40/exportsheet') ?>',
            method: "GET",
            data: {
                date: $('#date').val()
            },
            ...
            success: function(response) {
                ...
                link.download = 'Rekap_BC_4.0_' + date + '.xlsx';
