...
<section class="section">
    <div class="section-header">
        <h1>Rekap Pembuatan Dokumen BC 3.0</h1>
...
<script>
    ...
    function drawTable() {
        $.ajax({
            url: '<?= base_url('/dashboard/list-dokumen-bc30/all') ?>',
            method: "GET",
            data: {
                date: $('#date').val()
            },
    ...
    function exportSheet(event) {
        ...
        $.ajax({
            url: '<?= base_url('/dashboard/list-dokumen-bc30/exportsheet') ?>',
            method: "GET",
            data: {
                date: $('#date').val()
            },
            ...
            success: function(response) {
                ...
                link.download = 'Rekap_BC3.0_' + date + '.xlsx';
