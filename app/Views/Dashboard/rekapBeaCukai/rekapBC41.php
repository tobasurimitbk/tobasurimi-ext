...
<section class="section">
    <div class="section-header">
        <h1>Rekap Pembuatan Dokumen BC 4.1</h1>
...
<script>
    ...
    function drawTable() {
        $.ajax({
            url: '<?= base_url('/dashboard/list-dokumen-bc41/all') ?>',
            method: "GET",
            data: {
                date: $('#date').val()
            },
    ...
    function exportSheet(event) {
        ...
        $.ajax({
            url: '<?= base_url('/dashboard/list-dokumen-bc41/exportsheet') ?>',
            method: "GET",
            data: {
                date: $('#date').val()
            },
            ...
            success: function(response) {
                ...
                link.download = 'Rekap_BC_4.1_' + date + '.xlsx';
