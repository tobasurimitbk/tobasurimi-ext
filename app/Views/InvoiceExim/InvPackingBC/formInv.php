        ...
        <div class="col-button-tambah-spp">
            ...
            <?php if (!empty($dataInvoice)) { ?>
                <?php if (can('Invoice Exim', 'CIPL BC', 'p')): ?>
                    <button target="_blank" class="btn btn-warning btn-print float-right" onclick="print('<?= encrypt($dataInvoice['id']) ?>')">
                        Print
                    </button>
                <?php endif; ?>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered nowrap table-hover-tobasurimi dataTable" id="barangTable" width="100%" cellspacing="0">
                            ...
                            <tfoot class="foot-barang" id="foot-barang">
                                <tr>
                                    <td colspan="8">List Barang Kosong</td>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
            ...
            <form id="form-barang" role="form" method="POST">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating mb-3" style="height: 50px;">
                                <select class="form-select hs_code_barang" name="hs_code_barang" id="hs_code_barang">
                                    <option value=""></option>
                        ...
                        <div class="col-md-6">
                            <div class="form-floating mb-3" style="height: 50px;">
                                <input autocomplete="one-time-code" type="text" class="form-control qty_barang" id="qty_barang" name="qty_barang" placeholder="Qty Barang" onkeyup="this.value = greatFormatRupiah(this.value)">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating mb-3" style="height: 50px;">
                                <input autocomplete="one-time-code" type="text" class="form-control harga_satuan_barang" id="harga_satuan_barang" name="harga_satuan_barang" placeholder="Harga Satuan Barang" onkeyup="this.value = greatFormatRupiah(this.value)">
                                <label for="floatingInput">Harga Satuan</label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-floating mb-3" style="height: 50px;">
                                <input autocomplete="one-time-code" type="text" class="form-control total_harga_barang" id="total_harga_barang" name="total_harga_barang" placeholder="Total Harga Barang" onkeyup="this.value = greatFormatRupiah(this.value)">
            ...
            <form id="form-packing" role="form" method="POST">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating mb-3">
                                <textarea class="full-textarea form-control catatan_packing" id="catatan_packing" name="catatan_packing" placeholder="Catatan (Opsional)"></textarea>
                                <label for="floatingInput">Catatan (Opsional)</label>
                            </div>
                        </div>
...
<?php if (in_array(session()->get('login')->this_company_id, [1, 2]) && !empty($dataInvoice)): ?>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('.bank_id, .tax_id, .customer_id,.barang_id,.valas_id,.satuan_size_id,.hs_code,.hs_code_barang,.satuan_id,#company_id')
            .parent('div')
            .children('span')
            .children('span')
            .children('span')
        ...
        $('#qty_barang,#harga_satuan_barang').change(function(e) {
            e.preventDefault();
            var qtyBarang = destroyFormatRupiah($('#qty_barang').val());
            var hargaSatuanBarang = destroyFormatRupiah($('#harga_satuan_barang').val());

            var hargaTotalBarangFinal = parseFloat(hargaSatuanBarang * qtyBarang);
            $('#total_harga_barang').val(greatFormatRupiah(hargaTotalBarangFinal.toFixed(2)));
        });

        $('#qty_barang,#total_harga_barang').change(function(e) {
            e.preventDefault();
            var qtyBarang = destroyFormatRupiah($('#qty_barang').val());
            var totalHargaBarang = destroyFormatRupiah($('#total_harga_barang').val());

            var hargaSatuanBarangFinal = parseFloat(totalHargaBarang / qtyBarang);
            $('#harga_satuan_barang').val(greatFormatRupiah(hargaSatuanBarangFinal.toFixed(2)));
        });
        ...
        $('#btnSubmitBarang').click(function(e) {
            ...
            if ($('#form-barang').valid()) {
                ...
                var hsCode = $('#hs_code_barang option:selected').val();
                var hsCodeName = $('#hs_code_barang option:selected').data('hs_code_name');
                var satuanId = $('#satuan_id option:selected').val();
                var kodeSatuan = $('#satuan_id option:selected').text();
                var qty = destroyFormatRupiah($('#qty_barang').val());
                var hargaSatuanBarang = destroyFormatRupiah($('#harga_satuan_barang').val());
                var totalHargaBarang = destroyFormatRupiah($('#total_harga_barang').val());
                ...
                if (idBarang) {
                    ...
                    listBarang[index].hs_code = hsCode;
                    listBarang[index].hs_code_name = hsCodeName;
                    listBarang[index].qty = qty;
                    listBarang[index].satuan_id = satuanId;
                    listBarang[index].kode_satuan = kodeSatuan;
                    listBarang[index].harga_satuan_barang = hargaSatuanBarang;
                    listBarang[index].total_harga_barang = totalHargaBarang;
                    ...
                    listBarang.push({
                        ...
                        harga_satuan_barang: hargaSatuanBarang,
        ...
        $('#btnSubmitPacking').click(function(e) {
            ...
            if ($('#form-packing').valid()) {
                ...
                var catatanPacking = $('#catatan_packing').val();
                //------------------------------------------------------
                var canPacking = destroyFormatRupiah($('#can_packing').val());
                ...
                if (idPacking) {
                    ...
                    listPacking[index].nama_barang = namaBarangPacking;
                    listPacking[index].hs_code = hsCode;
                    listPacking[index].hs_code_name = hasCodeName;
                    listPacking[index].catatan = catatanPacking;
                    listPacking[index].size_breakdown = result;

                } else {
                    // CREATE
                    listPacking.push({
                        id_packing: getID(),
                        nama_barang: namaBarangPacking,
                        hs_code: hsCode,
                        hs_code_name: hasCodeName,
                        catatan: catatanPacking,
                        size_breakdown: result
                    });
                }
                                ...
                                success: function(response) {
                                    if (response.status) {
                                        Swal.fire({
                                            ...
                                            .then(() => {
                                                window.location.href = "<?= base_url("invoice-packing-bc/detail/" . encrypt($dataSalesOrderExport->sales_order_export_id)) ?>";
                                            })
                                    } else {
                                        Swal.fire({
                                            icon: 'error',
    ...
    function resetFormBarang() {
        ...
        $('#hs_code_barang').val(null).change();
        $('#satuan_id').val(null).change();
        $('#qty_barang').val(null);
        $('#harga_satuan_barang').val(null);
        $('#total_harga_barang').val(null);
        $('#catatan').val(null);
    }
    ...
    function drawTableBarang() {
        ...
        listBarang.forEach(item => {
            ...
            newRow.append(`<td>${item.kode_satuan}</td>`);
            newRow.append(`<td>${greatFormatRupiah(item.harga_satuan_barang)}</td>`);
            newRow.append(`<td>${greatFormatRupiah(item.total_harga_barang)}</td>`);
        ...
        `;
            ...
            totalQty += item.qty;
            totalTotalHarga += item.total_harga_barang;
        });
    ...
    function detailRowBarang(id_barang) {
        ...
        $('#total_harga_barang').val(greatFormatRupiah(item.total_harga_barang));
    ...
    function detailRowPacking(id_packing) {
        ...
        $('#nama_barang_packing').val(item.nama_barang);
        $('#hs_code').val(item.hs_code).change();
        $('#catatan_packing').val(item.catatan);
        //------------------------------------------
        $('#can_packing').val(greatFormatRupiah(size.can));
        $('#case_packing').val(greatFormatRupiah(size.case));
        $('#kg_packing').val(greatFormatRupiah(size.kg));
        $('#lb_packing').val(greatFormatRupiah(size.lb));
        $('#inner_box_packing').val(greatFormatRupiah(size.inner_box));
        $('#pc_packing').val(greatFormatRupiah(size.pc));
        $('#bag_packing').val(greatFormatRupiah(size.bag));
        $('#persen_packing').val(greatFormatRupiah(size.persen));
        $('#cup_packing').val(greatFormatRupiah(size.cup));
        $('#palet_packing').val(greatFormatRupiah(size.palet));
        $('#vgm').val(greatFormatRupiah(size.vgm));
        $('#packing').val(greatFormatRupiah(size.packing));
        $('#qty_packing').val(greatFormatRupiah(item.qty));
        $('#satuan_size_code').val(item.kode_satuan);
        $('#berat_bersih').val(greatFormatRupiah(size.berat_bersih));
        $('#berat_kotor').val(greatFormatRupiah(size.berat_kotor));
        $('#drammed').val(greatFormatRupiah(size.drammed));
    ...
    function recalculateTotal() {
        ...
        // List Barang
        $.each(listBarang, function(i, v) {
            totalInvoiceBarang += parseFloat(v.total_harga_barang);
        });
        // List Biaya Tambahan
        ...
        $.each(listPacking, function(i, v) {
            var size = v.size_breakdown;
            totalBeratBersih += parseFloat(size.berat_bersih);
            totalBeratKotor += parseFloat(size.berat_kotor);
        });
    ...
    function posting() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                const csrf = $(`[name="${csrfToken}"]`);
                $.ajax({
                    url: "<?= base_url("invoice-packing-bc/posting"); ?>",
                    data: {
                        id: $("#id").val(),
                    },
                    beforeSend: function(xhr) {
                        ...
                        if (response.status) {
                            Swal.fire({
                                ...
                                .then(() => {
                                    ...
                                    location.href = "<?= base_url('invoice-packing-bc/detail/') ?>" + salesOrderExportId;
                                })
                        }
                    },
                });
    ...
    function unposting() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                const csrf = $(`[name="${csrfToken}"]`);
                $.ajax({
                    url: "<?= base_url("invoice-packing-bc/unposting"); ?>",
                    data: {
                        id: $("#id").val(),
                    },
                    beforeSend: function(xhr) {
    ...
    function syncBarangPacking() {
        ...
        listBarang.forEach(item => {
            ...
            var cased = null;
            var can = null;
            if (item.satuan_id == 19) {
                cased = item.qty;
            } else if (item.satuan_id == 68) {
                can = item.qty;
            }
    ...
    function resetFormFormulaBeratKotor() {
        $('#formula_pilih_jumlah_case_can_hitung_berat_kotor').val(null).change();
    ...
    $('#btnAmbilBarang').click(function(e) {
        e.preventDefault();
        $.ajax({
            url: "<?= base_url("invoice-packing-bc/get-referensi-barang"); ?>",
            data: {
