...
<section class="section">
    <div class="section-header">
        ...
        <div class="col-button-tambah-spp">
            <a class="btn btn-hide-form btn-discard float-right" href="<?= base_url("invoice-packing-bc"); ?>">
                Kembali
            </a>
            <?php if (can('Invoice Exim', 'CIPL BC', 'c')) : ?>
                <a class="btn btn-show-form btn-success float-right" href="<?= base_url("invoice-packing-bc/create/" . encrypt($dataSalesOrderExport->sales_order_export_id)); ?>">
...
<script>
    ...
    function edit(id) {
        window.location.href = "<?= base_url('invoice-packing-bc/id') ?>" + '/' + id
    }

    function duplicate(id) {
        window.location.href = "<?= base_url('invoice-packing-bc/duplicate') ?>" + '/' + id
    }
    ...
    function remove(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                const csrf = $(`[name="${csrfToken}"]`);
                $.ajax({
                    url: "<?= base_url("invoice-packing-bc/delete"); ?>",
                    data: {
                        id: id,
                    },
                    beforeSend: function(xhr) {
