                    ...
                    <table class="table table-bordered nowrap table-hover-tobasurimi dataTable" id="dataTable" width="100%" cellspacing="0">
                        <thead class="thead-dark">
                            <tr>
                                ...
                                <th onclick="changeSort('sales_order_export.no_invoice')" class="sort">No PI</th>
                                <th onclick="changeSort('sales_order_export.tanggal_invoice')" class="sort">Tgl PI</th>
                                <th onclick="changeSort('sales_contract.customer_id')" class="sort">Term Of Payment</th>
                                <th onclick="changeSort('sales_contract.customer_id')" class="sort">Total Invoice</th>
