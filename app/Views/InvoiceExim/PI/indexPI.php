                    ...
                    if (status_posting == "0") {
                        res += `
                            <?php if (can('Invoice Exim', 'Proforma Invoice', 'p')) : ?>
                                <button data-toggle="tooltip" title="Print" class="btn btn-warning btn-print" onclick="print('<?= base_url("proforma-invoice/print/"); ?>${id}')" style="box-shadow: none !important;">
