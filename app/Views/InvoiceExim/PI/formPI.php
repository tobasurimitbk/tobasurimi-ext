                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-floating mb-3">
                            <input value="<?= $dataSalesOrderExport->no_invoice ?>" autocomplete="one-time-code" disabled type="text" class="form-control no_invoice" id="no_invoice" name="no_invoice">
                            <label for="floatingInput">No Invoice</label>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-floating mb-3">
                            <input value="<?= date('d/m/Y', strtotime($dataSalesOrderExport->tanggal_invoice))  ?>" autocomplete="one-time-code" disabled type="text" class="form-control no_invoice" id="no_invoice" name="no_invoice">
                            <label for="floatingInput">Tanggal Invoice</label>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-floating mb-3">
                            <input value="<?= $dataSalesOrderExport->sales_order_export_no ?>" autocomplete="one-time-code" disabled type="text" class="form-control no_invoice" id="no_invoice" name="no_invoice">
                            <label for="floatingInput">No Order Form</label>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-floating mb-3">
                            <input value="<?= $dataSalesOrderExport->customer_name ?>" autocomplete="one-time-code" disabled type="text" class="form-control no_invoice" id="no_invoice" name="no_invoice">
                            <label for="floatingInput">Buyer / Customer</label>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-floating mb-3">
                            <input value="<?= $dataSalesOrderExport->address ?>" autocomplete="one-time-code" disabled type="text" class="form-control no_invoice" id="no_invoice" name="no_invoice">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-floating mb-3" style="height: 50px;">
                            <div class="input-group input-group-password">
                                <div class="form-floating mb-3" style="height: 50px;">
                                    <input autocomplete="one-time-code" type="text" value="<?= !empty($dataPI) ? $dataPI['no_invoice'] : 'AUTO GENERATE' ?>" <?= !empty($dataPI) ? ($dataPI['status_posting'] == 1 ? 'readonly' : '') : 'readonly' ?> class="form-control no_invoice_pi" id="no_invoice_pi" name="no_invoice_pi" placeholder="No Invoice PI" required>
                    ...
                    <div class="col-md-4">
                        <div class="form-floating mb-3" style="height: 50px;">
                            <div class="input-group input-group-password">
                                <div class="form-floating mb-3" style="height: 50px;">
                                    <input <?= !empty($dataPI) ? ($dataPI['status_posting'] == 1 ? 'readonly' : '') : '' ?> autocomplete="one-time-code" class="form-control input-picker tanggal_invoice" id="tanggal_invoice" name="tanggal_invoice" placeholder="Tanggal Invoice" value="<?= !empty($dataPI) ? date('d/m/Y', strtotime($dataPI['tanggal_invoice'])) : date('d/m/Y')  ?>">
                    ...
                    <div class="col-md-4">
                        <div class="form-floating mb-3" style="height: 50px;">
                            <select <?= !empty($dataPI) ? ($dataPI['status_posting'] == 1 ? 'disabled' : '') : '' ?> class="form-select divisi_id" name="divisi_id" id="divisi_id">
                                <option value=""></option>
                                <?php foreach ($dataDivisi as $d): ?>
                                    <option <?= !empty($dataPI) ? ($dataPI['divisi_id'] == $d['id'] ? 'selected' : '') : '' ?> value="<?= $d['id'] ?>"><?= $d['divisi'] ?></option>
                                <?php endforeach; ?>
                            </select>
                    ...
                    <div class="col-md-4">
                        <div class="form-floating mb-3">
                            <textarea class="full-textarea form-control payment_term_parent" id="payment_term_parent" name="payment_term_parent" placeholder="Payment Term"><?= strip_tags($dataSalesOrderExport->payment_term); ?></textarea>
                            <label for="floatingInput">Term Of Payment</label>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-floating mb-3">
                            <textarea class="full-textarea form-control payment_instruction" id="payment_instruction" name="payment_instruction" placeholder="Payment Instruction"></textarea>
                        ...
                        <div class="form-floating mb-3" style="height: 50px;">
                            <select class="form-select bank_id" id="bank_id" name="bank_id">
                                ...
                                <?php foreach ($dataBank as $d) : ?>
                                    <option value="<?= $d["id"]; ?>"><?= $d["name"] . " - " . $d['atas_nama'] . " - " . $d['no_rekening']; ?></option>
                                <?php endforeach ?>
                            </select>
                    ...
                    <div class="col-md-4">
                        <div class="form-floating mb-3">
                            <input autocomplete="one-time-code" type="text" class="form-control packing" id="packing" name="packing">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('.divisi_id, .bank_id, .tax_id, .customer_id,.barang_id,.valas_id,.satuan_id')
            .parent('div')
            .children('span')
            .children('span')
            .children('span')
