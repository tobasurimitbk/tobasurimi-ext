...
<script>
    ...
    $(document).ready(function() {
        ...
        $('.bank_id, .tax_id, .customer_id,.barang_id,.valas_id,.satuan_size_id,.hs_code,.company_id')
            .parent('div')
            .children('span')
            .children('span')
            .children('span')
    ...
    function print(id) {
        ...
        <?php else: ?>
            ...
            var url = "<?= base_url('invoice-packing-customer/print/') ?>" + id + '?company_id=' + companyId;
