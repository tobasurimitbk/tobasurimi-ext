            ...
            <div class="row justify-content-end row-col-spp mb-3">
                <div class="col mb-3">
                    <div class="input-group input-group-password">
                        <input autocomplete="one-time-code" class="form-control input-picker dateStart" id="dateStart" name="dateStart" placeholder="Start Date" value="<?= date('d/m/Y') ?>">
                ...
                render: function(data, type, row) {
                    ...
                    return `
                        <div class="mt-0">
                            ...
                            <a href="<?= base_url('invoice-packing-customer/detail'); ?>/${id}"  data-toggle="tooltip" title="List CIPL" class="btn btn-danger">
