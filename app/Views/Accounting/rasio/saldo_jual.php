<div class="row justify-content-end">
    <div class="col mb-3">
        <label class="form-label font-weight-bold lable-title">Data Saldo Jual</label>
    </div>
</div>
<div class="row mb-2">
    <div class="col-md-12">
        <div class="table-responsive">
            <table class="table table-bordered nowrap table-hover-tobasurimi dataTable" id="selectedItemTableSaldoJual" width="100%" border="1" cellspacing="0">
                <thead class="thead-dark">
                    <tr>
                        <th style="text-align: center;" rowspan="2">No</th>
                        <th style="text-align: center;" colspan="5">Data Saldo Jual</th>
                    </tr>
                    <tr>
                ...
                <tbody class="body-detail-table-saldo-jual">
                </tbody>
                <tfoot style="background: #ffffff !important;" class="tfoot-detail-table-saldo-jual" id="tfoot-detail-table-saldo-jual">
                    <tr>
