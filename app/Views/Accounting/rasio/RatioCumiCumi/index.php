...
<section class="section">
    <div class="section-header">
        <h1>Ratio Cumi Cumi</h1>
        <?php if (can("Accounting", "Ratio Cumi Cumi", "c")) : ?>
            <a href="<?= base_url('ratio-cumi-cumi/create') ?>" type="button" class="btn btn-show-form btn-add float-right">
...
<script>
    ...
    $(document).ready(function() {
        ...
        const table = $('.dataTable').DataTable({
            ...
            pageLength: 25,
            ajax: {
                url: "<?= base_url("ratio-cumi-cumi/all"); ?>",
                dataSrc: "data",
                data: function(data) {
        ...
        $('#dataTable tbody').on('click', 'tr td:not(.actions):not(.dataTables_empty)', function() {
            ...
            console.log(data);
            location.replace(`<?= base_url("ratio-cumi-cumi/id"); ?>/${data.id}`);
        });
    });
    // sort
