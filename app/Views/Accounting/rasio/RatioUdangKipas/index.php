...
<section class="section">
    <div class="section-header">
        <h1>Ratio Udang Kipas</h1>
        <?php if (can("Accounting", "Ratio Udang Kipas", "c")) : ?>
            <a href="<?= base_url('ratio-udang-kipas/create') ?>" type="button" class="btn btn-show-form btn-add float-right">
...
<script>
    ...
    $(document).ready(function() {
        ...
        const table = $('.dataTable').DataTable({
            ...
            pageLength: 25,
            ajax: {
                url: "<?= base_url("ratio-udang-kipas/all"); ?>",
                dataSrc: "data",
                data: function(data) {
        ...
        $('#dataTable tbody').on('click', 'tr td:not(.actions):not(.dataTables_empty)', function() {
            ...
            console.log(data);
            location.replace(`<?= base_url("ratio-udang-kipas/id"); ?>/${data.id}`);
        });
    });
    // sort
