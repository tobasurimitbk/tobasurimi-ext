...
<div class="row mb-2">
    <div class="col-md-12">
        <div class="table-responsive">
            <table class="table table-bordered nowrap table-hover-tobasurimi dataTable" id="selectedItemTableBahanFilling" width="100%" border="1" cellspacing="0">
                <thead class="thead-dark">
                    <tr>
                        <th style="text-align: center;" rowspan="2">No</th>
                        <th style="text-align: center;" colspan="5">Data Barang Filling</th>
                    </tr>
                    <tr>
                ...
                <tbody class="body-detail-table-barang-filling">
                </tbody>
                <tfoot style="background: #ffffff !important;" class="tfoot-detail-table-table-barang-filling" id="tfoot-detail-table-table-barang-filling">
                    <tr>
