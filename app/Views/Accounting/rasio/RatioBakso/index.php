...
<section class="section">
    <div class="section-header">
        <h1>Ratio Bakso</h1>
        <?php if (can("Accounting", "Ratio Bakso", "c")) : ?>
            <a href="<?= base_url('ratio-bakso/create') ?>" type="button" class="btn btn-show-form btn-add float-right">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#dataTable tbody').on('click', 'tr td:not(.actions):not(.dataTables_empty)', function() {
            ...
            console.log(data);
            location.replace(`<?= base_url("ratio-bakso/id"); ?>/${data.id}`);
        });
    });
    // sort
