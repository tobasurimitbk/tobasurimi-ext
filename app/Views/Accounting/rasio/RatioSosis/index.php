...
<section class="section">
    <div class="section-header">
        <h1>Ratio Sosis</h1>
        <?php if (can("Accounting", "Ratio Sosis", "c")) : ?>
            <a href="<?= base_url('ratio-sosis/create') ?>" type="button" class="btn btn-show-form btn-add float-right">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#dataTable tbody').on('click', 'tr td:not(.actions):not(.dataTables_empty)', function() {
            ...
            console.log(data);
            location.replace(`<?= base_url("ratio-sosis/id"); ?>/${data.id}`);
        });
    });
    // sort
