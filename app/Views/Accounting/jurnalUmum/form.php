                    ...
                    <div class="col-md-4">
                        <div class="form-floating mb-3" style="height: 50px;">
                            <div class="input-group input-group-password">
                                <div class="form-floating mb-3" style="height: 50px;">
                                    <input <?= isset($tutupBuku) ? ($tutupBuku ? 'readonly' : '') : '' ?> readonly autocomplete="one-time-code" value="<?= !empty($transaksiJurnal) ? $transaksiJurnal['no_bukti'] : "" ?>" type="text" class="form-control no_bukti" id="no_bukti" name="no_bukti" placeholder="No Bukti">
