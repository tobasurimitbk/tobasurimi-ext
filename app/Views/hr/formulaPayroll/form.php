...
<section class="section">
    <div class="section-header">
        ...
        <div class="col-button-tambah-spp">
            <a class="btn btn-hide-form btn-discard float-right" href="<?= base_url("formula-payroll"); ?>">
                Batal
            </a>
        ...
        if ($(".create-form").valid()) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    if (id) {
                        $.ajax({
                            url: "<?= base_url("formula-payroll/update"); ?>",
                            data: data,
                    ...
                    // CREATE
                        ...
                        $.ajax({
                            url: "<?= base_url("formula-payroll/save"); ?>",
                            data: data,
                            beforeSend: function(xhr) {
                                xhr.setRequestHeader('X-CSRF-Token', csrf.val());
                            },
