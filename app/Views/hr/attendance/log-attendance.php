                        ...
                        <thead>
                            <tr>
                                ...
                                for ($i = 1; $i <= $last_date; $i++) :
                                    ...
                                    if (date("N", $temp) == 7) :
                                        echo "<td align=center  style=\"vertical-align:middle;\" width=\"25\" height=\"25\"><font color='red'>IN " . $i . "</font></td>";
                                        echo "<td align=center  style=\"vertical-align:middle;\" width=\"25\" height=\"25\"><font color='red'>OUT " . $i . "</font></td>";
                                    else :
                                        echo "<td align=center style=\"vertical-align:middle;\" width=\"25\" height=\"25\">IN<br> " . $i . "</td>";
