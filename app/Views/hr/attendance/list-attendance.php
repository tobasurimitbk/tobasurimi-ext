    ...
    <div class="modal-dialog" style="min-width: 900px;">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><label class="title-name"></label> List Attendance</h5>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table nowrap table-hover-tobasurimi dataTable" id="dataTable" width="100%" cellspacing="0">
                        <thead class="thead-dark">
                            <tr>
                                <th onclick="changeSort('nip')" class="sort">No</th>
                                <th onclick="changeSort('name')" class="sort">NIP</th>
                                <th onclick="changeSort('divisionName')" class="sort">Nama</th>
                                <th onclick="changeSort('email')" class="sort">Periode</th>
                                <th onclick="changeSort('phone_no')" class="sort">Hadir</th>
                                <th onclick="changeSort('address')" class="sort">Alpha</th>
                                <th onclick="changeSort('dob')" class="sort">Sakit</th>
                                <th onclick="changeSort('gender')" class="sort">Ijin</th>
                                <th onclick="changeSort('acc_no')" class="sort">Cuti</th>
                                <th onclick="changeSort('status')" class="sort">Libur</th>
                            </tr>
                        </thead>
