    ...
    <div class="section-header">
        ...
        <div class="col-button-tambah-spp">
             <?php if (can("Jasa Vendor", "Barang Masuk", "c")) : ?>
                <a href="<?= base_url('jasa-vendor-in/create') ?>" type="button" class="btn btn-show-form btn-save float-right btn-submit-parent" >
...
<script>
    ...
    function printFiltered() {
        ...
        let printUrl = '<?= base_url("jasa-vendor-in/print-filter") ?>?';
