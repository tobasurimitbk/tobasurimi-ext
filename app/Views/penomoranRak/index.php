    ...
    <div class="modal-dialog" style="max-width: 1200px !important;">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><label class="title-name"></label> Penomoran Rak</h5>
            </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="form-floating mb-3" style="height: 50px;">
                                <input type="text" class="form-control nomor" id="nomor" name="nomor" placeholder="Nomor">
                                <label for="floatingInput">Nomor</label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-floating mb-3" style="height: 50px;">
                                <input type="text" class="form-control rak" id="rak" name="rak" placeholder="Rak">
...
<div class="container-fluid">
    <div">
        <h4 style="padding-top: 6px; color: #3B4758;" class="m-0 font-weight-bold my-2">Penomoran Rak</h4>
...
<script>
    ...
    $(document).ready(function() {
        ...
        const table = $('.dataTable').DataTable({
            ...
            pageLength: 25,
            ajax: {
                url: "<?= base_url("penomoran-rak/all"); ?>",
                dataSrc: "data",
                data: function(data) {
        ...
        $(".delete-btn").click(function() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    setLoading()
                    $.ajax({
                        url: "<?= base_url("penomoran-rak/delete"); ?>",
                        data: {
                            id: id
                        },
                        beforeSend: function(xhr) {
