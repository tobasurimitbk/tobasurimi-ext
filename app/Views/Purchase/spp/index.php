            ...
            <div class="row justify-content-end row-col-spp">
                <div class="col mb-3">
                    ...
                    <div class="input-group input-group-password">
                        <input disabled autocomplete="one-time-code" class="form-control input-picker dateStart" id="dateStart" name="dateStart" placeholder="Tanggal Awal" value="01<?= date('/m/Y') ?>">
                ...
                <div class="col mb-3">
                    <div class="input-group input-group-password">
                        <input disabled autocomplete="one-time-code" class="form-control input-picker dateEnd" id="dateEnd" name="dateEnd" placeholder="Tanggal Akhir">
                        <div class="input-group-prepend group-prepend-password align-items-center">
