...
<section class="section">
    <div class="section-header">
        ...
        <a class="btn btn-show-form btn-add float-right" href="<?= base_url("retur-barang/create"); ?>">
    ...
    <div class="card">
        <div class="card-body">
            <div class="row justify-content-end row-col-spp">
                ...
                <div class="col mb-3">
                    <input autocomplete="one-time-code" class="form-control search form-out-search" placeholder="Ketik No Retur" value="" />
                </div>
            </div>
            <div class="row">
