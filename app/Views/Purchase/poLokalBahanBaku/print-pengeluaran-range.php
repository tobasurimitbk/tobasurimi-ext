    ...
    <?php foreach ($data as $d): ?>
        ...
        <div class="section">
            ...
            <div class="d-flex w-100">
                <div style="display: inline-block;">
                    <table>
                        <tr>
                            <td>TGL</td>
                            <td>. <u><?= date('d-M-Y', strtotime($d['po_date'])) ?></u></td>
                        </tr>
                        <tr>
                            <td>DIBAYAR KEPADA</td>
                            <td>: <u><?= $d['supplier_name'] ?></u></td>
                        </tr>
                    </table>
                </div>
            ...
            <table class="w-100 bank-table border-collapse">
                ...
                <tr>
                    <td>Pembayaran <?= $d['barang_name'] ?> sebanyak <?= $d['nilai_total_qty'] . " KG "  ?> (No: <?= $d['po_no'] ?>)</td>
                    <td class="txt-right">Rp <?= number_format($d['nilai_total_umum'], 2) ?></td>
                    <td></td>
                </tr>
                <tr>
                    <th class="txt-right">TOTAL</th>
                    <th class="txt-right">Rp <?= number_format($d['nilai_total_umum'], 2) ?></th>
                    <th></th>
                </tr>
            </table>
            ...
            <div style="margin-top: 0.5rem;margin-bottom: 0.5rem">
                <span>TERBILANG:</span>
                <span style="text-transform: uppercase;"><u><?= terbilang($d['nilai_total_umum']) . ' RUPIAH' ?></u></span>
            </div>
            ...
            <table class="w-100 sign-table border-collapse">
                ...
                <tr>
                    ...
                    <td>TGL</td>
                    <td>TGL</td>
                    <td class="txt-center"><?= $d['supplier_name'] ?></td>
                </tr>
            </table>
            <br>
