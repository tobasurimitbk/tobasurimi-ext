        ...
        <div class="pagebreak">
            ...
            <table class="item-table" style="margin-top: 5px;">
                ...
                <?php foreach ($dataBarang as $detail): ?>
                    <tr>
                        <td style="border-left: 1px solid black; border-right: 1px solid black;font-size:13px;height:4%;"><?= $dataPO->from_import == "yes" ? $detail['note'] :  $detail['peti'] ?></td>
                        <td style="border-left: 1px solid black; border-right: 1px solid black;font-size:13px;"><?= $detail['divisi'] ?></td>
                        <td style="border-left: 1px solid black; border-right: 1px solid black;font-size:13px;"><?= $dataPO->from_import == "yes"  ? $detail['peti'] :  $detail['note'] ?></td>
