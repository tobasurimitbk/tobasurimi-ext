                        ...
                        if (row_detail) {
                            ...
                            list_items.map(item => {
                                if (item.row == row_detail) {
                                    ...
                                    tag_html += "<td>";
                                    tag_html += `
                                    <button class="btn btn-warning posting-spp mr-1 edit-table-detail" data-barang_id="${barangId}" data-kode_barang="${kode}" data-nama_barang="${barangName}" data-satuan="${satuanName}" data-harga="${harga}" 
