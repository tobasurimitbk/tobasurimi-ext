            ...
            <form class="create-form form-add-spp" role="form" method="POST" enctype="multipart/form-data">
                ...
                <?php if ($isUpdate ?? false) : ?>
                    ...
                    <div class="row">
                        ...
                        <!-- <div class="col-md-6">
                    <div class="form-floating mb-3" style="height: 50px;">
                        <input autocomplete="one-time-code" value="<?= $dataTerimaFaktur->item_total ?? 0; ?>" type="text" class="form-control nominal_faktur" name="nominal_faktur" id="nominal_faktur" disabled readonly>
