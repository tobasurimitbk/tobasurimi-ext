        ...
        <div class="card-body">
            <form class="create-form form-add-spp" role="form" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6">
                        <div class="form-floating mb-3" style="height: 50px;">
                            <div class="input-group input-group-password">
                                <div class="form-floating mb-3" style="height: 50px;">
                                    <input autocomplete="one-time-code" value="<?= $dataTerimaFaktur->faktur_no ?? ""; ?>" type="text" class="form-control no" id="no" name="no" placeholder="No. Terima Faktur " disabled readonly>
                                    <label for="floatingInput">No. Terima </label>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-floating mb-3" style="height: 50px;">
                            <input type="hidden" name="tipe_bahan" class="tipe_bahan" value="PENOLONG">
                            <select disabled <?= !empty($dataTerimaFaktur) ? ($statusUpdate ? "disabled=true" : "") : ""; ?> onchange="changeTipeBahan()" class="form-select tipe_bahan" id="tipe_bahan" name="tipe_bahan" aria-label="Floating label select example">
                                ...
                                <option selected value="PENOLONG" <?= !empty($dataTerimaFaktur) ? ($dataTerimaFaktur->tipe_bahan === "PENOLONG" ? "selected" : "") : ""; ?>>BAHAN PENOLONG</option>
                            </select>
        ...
        columnDefs: [{
            ...
            },
            {
                render: function(data, type, row) {
                    return `<div class="form-check"><input autocomplete="one-time-code" class="form-check-input" type="checkbox" ></div>`
                },
                targets: 0
            },
            {
                render: function(data, type, row) {
                    return `<input autocomplete="one-time-code" class="form-control" type="text" value="${data}">`
                },
                targets: 8
            }
        ],
