...
<script>
    ...
    $('#harga_satuan,#qty,#diskon,#biaya_tambahan').keyup(function() {
        ...
        if (additionalCostType == '' || additionalCostType == 'PLUS') {
            biayaTambahan = 0;
                ...
                success: function(response) {
                    $.each(response.data, function(i, v) {
                        listBarang.push({
                            ...
                            total: destroyFormatRupiah(parseFloat(v.total).toFixed(2)),
