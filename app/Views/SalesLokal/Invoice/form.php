                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-floating ff-ket mb-3" style="height: 50px;">
                            <textarea <?= !empty($data) && $data->keterangan !== null ? ($data->Keterangan === true ? 'disabled=true' : '') : ''; ?> class="form-control Keterangan text-area-all" id="Keterangan" name="Keterangan" placeholder="Keterangan"><?= !empty($data) && $data->keterangan !== null ? $data->Keterangan : ""; ?></textarea>
