                    ...
                    if (res.dataSpekDetail && res.dataSpekDetail.length > 0) {
                        ...
                        res.dataSpekDetail.forEach(function(item) {
                            ...
                            var newRow = '<tr>' +
                                ...
                                '<input autocomplete="one-time-code" type="text" class="form-control" name="harga_pokok_old[]" id="harga_pokok" onkeyup="this.value = this.value.replace(/[^0-9,]/g, "");" onchange="this.value = formatRupiah(this.value);" value="' + item.harga_pokok + '"><label for="floatingInput">HPP</label>' +
                                '</div></div>' +
                ...
                if (counters) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            setLoading()
                            $.ajax({
                                url: "<?= base_url("master-barang-lokal/delete-spek"); ?>",
                                data: {
                                    id: idSpek
                                },
                                beforeSend: function(xhr) {
