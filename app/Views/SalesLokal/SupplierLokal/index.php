...
<script>
    ...
    const dataTableLokal = $('#dataTableLokal').DataTable({
        ...
        pageLength: 25,
        ajax: {
            url: "<?= base_url("supplier-lokal/all"); ?>",
            dataSrc: "data",
            data: function(data) {
    ...
    function edit(id) {
        ...
        $.ajax({
            url: "<?= base_url("supplier-lokal/id"); ?>" + "/" + id,
            method: "GET",
            dataType: "json",
            beforeSend: function() {
                setLoading();
    ...
    function destroy(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                setLoading()
                $.ajax({
                    url: "<?= base_url("supplier-lokal/delete"); ?>",
                    data: {
                        id: id
                    },
    ...
    $(document).ready(function() {
        ...
        $('#btn-export').on('click', function(e) {
            ...
            let exportUrl = `/supplier-lokal/export-excel?customerType=${customerType}&search=${search}&sort=${sort}&sortType=${sortType}`;
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        if (id) {
                            ...
                            $.ajax({
                                url: "<?= base_url("supplier-lokal/save"); ?>",
                                data: data,
                                beforeSend: function(xhr) {
                                    xhr.setRequestHeader('X-CSRF-Token', csrf.val());
                                    setLoading();
    ...
    function changeStatus() {
        ...
        if (isChecked) {
            ...
            $.ajax({
                url: `<?= base_url("supplier-lokal/generate-no"); ?>`,
                method: "GET",
                beforeSend: function() {
                    setLoading();
                },
