                ...
                <div class="table-responsive">
                    <table class="table table-bordered nowrap table-hover-tobasurimi dataTable" id="dataTable" width="100%" cellspacing="0">
                        <thead class="thead-dark">
                            <tr>
                                <th onclick="changeSort('biaya_lokal.id')" style="width: 10px;">No</th>
                                <th onclick="changeSort('biaya_lokal.divisi_id')" class="sort">Departemen</th>
                                <th onclick="changeSort('biaya_lokal.tanggal_invoice')" class="sort">Tanggal</th>
                                <th onclick="changeSort('biaya_lokal.no_invoice')" class="sort">Invoice</th>
                                <th onclick="changeSort('biaya_lokal.vendor_pelayaran_id')" class="sort">Vendor</th>
                                <th onclick="changeSort('biaya_lokal.total_faktur')" class="sort">Total</th>
                                <th onclick="changeSort('biaya_lokal.status_posting_exim')" class="sort">Exim</th>
                                <th onclick="changeSort('biaya_lokal.status_posting_acc')" class="sort">Acc</th>
                                <th onclick="changeSort('biaya_lokal.status_posting_audit')" class="sort">Audit</th>
                                <th onclick="changeSort('biaya_lokal.status_bayar')" class="sort">Kasir</th>
...
<script>
    ...
    let sort = "biaya_lokal.tanggal_invoice";
    let sortType = "desc";
    ...
    function detail(id) {
        ...
        window.open(
            "<?= base_url('biaya-lokal/detail/') ?>" + id,
            "_blank",
    ...
    function posting(id) {
        $.ajax({
            url: `<?= base_url("biaya-lokal/get-status-posting"); ?>`,
            method: "GET",
            beforeSend: function() {
                setLoading();
            },
    ...
    $('#btnSubmitPosting').click(function(e) {
        ...
        if (state) {
            ...
            const id = $('#id').val();
            $.ajax({
                url: "<?= base_url("biaya-lokal/update-status-posting"); ?>",
                data: {
                    id: id,
