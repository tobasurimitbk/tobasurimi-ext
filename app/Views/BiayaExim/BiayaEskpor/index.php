...
<section class="section">
    <div class="section-header">
        <h1>Biaya Eskpor</h1>
        <?php if (can('Biaya Exim', 'Biaya Eskpor', 'c')) : ?>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered nowrap table-hover-tobasurimi dataTable" id="dataTable" width="100%" cellspacing="0">
                        <thead class="thead-dark">
                            <tr>
                                <th>No</th>
                                <th onclick="changeSort('dicharge_port')" class="sort">Tanggal</th>
                                <th onclick="changeSort('sales_contract_no')" class="sort">No. Faktur</th>
                                <th onclick="changeSort('customer_name')" class="sort">No Order Form</th>
                                <th onclick="changeSort('shipment_date')" class="sort">Customer</th>
                                <th onclick="changeSort('createdAt')" class="sort">Destination</th>
