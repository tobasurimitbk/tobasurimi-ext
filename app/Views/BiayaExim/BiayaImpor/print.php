...
<head>
    ...
    <title><?= $dataBiayaImpor['no_invoice'] ?></title>
    <style>
        body {
            font-size: 12px;
        ...
        <div class="d-flex w-100">
            <div style="display: inline-block;">
                <table>
                    <tr>
                        <td>NO INVOICE</td>
                        <td>: <?= $dataBiayaImpor['no_invoice'] ?></td>
                    </tr>
                    <tr>
                        <td>TGL</td>
                        <td>: <?= date('d/m/Y', strtotime($dataBiayaImpor['tanggal_invoice'])) ?></td>
                    </tr>
                    <tr>
                        <td>DIBAYAR KEPADA</td>
                        <td>: <?= $dataBiayaImpor['nama_vendor'] ?></td>
                    </tr>
