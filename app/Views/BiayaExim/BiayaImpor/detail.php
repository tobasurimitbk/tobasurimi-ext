        ...
        <div class="card-body">
            <div class="section-header">
                <div class="col-button-tambah-spp">
                    <a class="btn btn-warning btn-print float-right" href="<?= base_url('biaya-impor/print/' . encrypt($dataBiayaImpor['id'])) ?>" target="_blank">
            ...
            <div class="row">
                <div class="col ">
                    <div class="alert alert-secondary">
                        <label class="form-label font-weight-bold text-black lable-title">DETAIL BIAYA IMPOR</label>
                    </div>
                </div>
            ...
            <div class="row">
                    ...
                    <table class="table">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <?= date('d/m/Y', strtotime($dataBiayaImpor['tanggal_invoice']))  ?>
                                </td>
                            </tr>
                            <tr>
                                <td>Departemen</td>
                ...
                <div class="col-sm">
                    <table class="table">
                        <tbody>
                            <tr>
                                <td style="width: 180px;">Consigne</td>
                                <td style="width: 10px;">:</td>
                                <td>
                                    <?= $dataBiayaImpor['consigne'] ?>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <?= $dataBiayaImpor['port_of_origin'] ?>
                                </td>
                            </tr>
                            <tr>
                                <td>Port Of Destination</td>
                                <td>:</td>
                                <td><?= $dataBiayaImpor['port_of_destination'] ?></td>
                            </tr>
                            <tr>
                                <td>Nilai Faktur</td>
                                <td>:</td>
                                <td><?= number_format($dataBiayaImpor['total_faktur'], 2) ?></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div class="row">
                <div class="col ">
                    <div class="alert alert-secondary">
                        <label class="form-label font-weight-bold text-black lable-title">LIST BIAYA IMPOR</label>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col ">
                    <div class="alert alert-secondary">
                        <label class="form-label font-weight-bold text-black lable-title">LIST CONTAINER</label>
                    </div>
                </div>
            </div>
            ...
            <table class="table table-bordered dataTable nowrap table-hover-tobasurimi" id="taxTable" width="100%" cellspacing="0">
                <thead class="thead-dark">
                    <tr>
                        ...
                        <th scope="col">Detail Container</th>
                    </tr>
                </thead>
                <tbody>
                    <?php $no = 1 ?>
            ...
            <div class="row">
                <div class="col ">
                    <div class="alert alert-secondary">
                        <label class="form-label font-weight-bold text-black lable-title">LIST BARANG DI IMPOR</label>
                    </div>
                </div>
            </div>
